...
class WithdrawalDetail extends Model
{
    ...
    protected $fillable = ['withdrawal_id', 'type', 'email', 'account_name', 'account_number', 'bank_branch_name', 'bank_branch_city', 'bank_branch_address', 'country', 'swift_code','bank_name', 'bank_id'];
