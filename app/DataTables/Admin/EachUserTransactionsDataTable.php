...
class EachUserTransactionsDataTable extends DataTable
{
    public function ajax(): JsonResponse
    {
        ...
        return datatables()
            ...
            {
                $d=strtotime($transaction->created_at);
           ...
           ->addColumn('receiver', function ($transaction)
            ...
            ->editColumn('transaction_type_id',function($transaction){
                  ...
                  $transaction_typ= $transaction->transaction_type->name;
                  
                  if($transaction_typ=="Request_To"){
                        $transaction_typ="Request Received";
                  }else if($transaction_typ=="Request_From"){
                        $transaction_typ="Request Sent";
                  }
            ...
            ->rawColumns(['sender','receiver','total', 'status','transaction_type_id', 'action'])
            ->make(true);
            // ->editColumn('transaction_type_id', function ($transaction)
            // {
    ...
    {
        return $this->builder()
            ->addColumn(['data' => 'id', 'name' => 'transactions.id', 'title' => 'ID', 'searchable' => true, 'visible' => true])
