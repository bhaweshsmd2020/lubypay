...
class MoneyTransferController extends Controller
{
    ...
    public function sendMoneyConfirm(Request $request)
    {
        ...
        $pending_transaction->percentage               = @$arr['charge_percentage'] ? @$arr['charge_percentage'] : 0;
        $pending_transaction->charge_percentage        = @$arr['charge_percentage'] ? $arr['p_calc'] : 0;
        $pending_transaction->charge_fixed             = @$arr['charge_fixed'] ? @$arr['charge_fixed'] : 0;
