...
class CurrencyController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.currencies.view', $data);
    }
        ...
        else if ($_POST)
        {
            ...
            try
            {
                ...
                if ($request->type == 'fiat')
                {
                    ...
                    $currency->card_rate          = $request->card_rate;
                    $currency->card_exchange_from = $request->card_exchange_from;
    ...
    public function update(Request $request, $id)
    {
        if (!$_POST)
        {
            ...
            $data['result'] = $result = Currency::find($id);
             $data['total_currency'] = $total_currency = Currency::count();
        ...
        else if ($_POST)
        {
            ...
            try
            {
                ...
                if($request->hasFile('logo')){
                    ...
                    $filename = Currency::find($id)->logo;
                }
                $currency->logo = $filename;
                $currency->save();
