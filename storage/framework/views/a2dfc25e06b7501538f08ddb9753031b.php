...
<?php $__env->startSection('title', 'Address Verification'); ?>
<?php $__env->startSection('page_content'); ?>
    ...
    <div class="box">
        <div class="box-body">
            <form class="form-horizontal" action="<?php echo e(url('admin/address-proofs')); ?>" method="GET">
                                    ...
                                    <tr>
                                        ...
                                        <td class=" dt-center">
                                            <?php if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_identity_verfication')): ?>
                                                <a href="<?php echo e(url('admin/address-proofs/edit/' . $document->id)); ?>" class="label label-primary"><i class="glyphicon glyphicon-edit"></i></a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lubynet/public_html/lubypaynew/resources/views/admin/verifications/address_proofs/list.blade.php ENDPATH**/ ?>