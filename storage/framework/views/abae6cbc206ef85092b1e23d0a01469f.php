<?php $__env->startSection('title', 'Add Subscription'); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                ...
                <form action="<?php echo e(url('admin/store-subscription')); ?>" class="form-horizontal" method="POST" id="user_form" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="box-body">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lubypay\resources\views/admin/subscription/create.blade.php ENDPATH**/ ?>