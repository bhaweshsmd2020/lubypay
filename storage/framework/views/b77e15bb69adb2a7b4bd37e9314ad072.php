                    ...
                    <div class="container-fluid">
                        <?php if(isset($logo)): ?>
                            <a href="<?php echo e(url('/')); ?>">
                                <img src="<?php echo e(url('public/frontend/images/logomain.png')); ?>" alt="logo" class="img-responsive" style="background-color: #fff; border-radius: 10px; padding: 5px; width: 116px; height: 50px; margin-left: 30px;">
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(url('/')); ?>">
                                <img src="<?php echo e(url('public/frontend/images/logomain.png')); ?>" alt="logo" class="img-responsive" style="background-color: #fff; border-radius: 10px; padding: 5px; width: 116px; height: 50px; margin-left: 30px;">
                            ...
                            <div class="row">
                                <div class="col-md-3" style="padding-top: 10px">
                                    <?php if(Auth::user()->picture): ?>
                                        <img src="<?php echo e(url('public/user_dashboard/profile/'.Auth::user()->picture)); ?>" class="rounded-circle rounded-circle-custom" id="profileImageHeader">
                                    <?php else: ?>
                                ...
                                <div class="col-md-9 username text-left">
                                    <a href="#" class="dropdown-toggle text-light" data-toggle="dropdown"><span id="subStringUserName" title="<?php echo e($user->first_name.' '.$user->last_name); ?>"><?php echo e($fullName); ?>-<b><?php echo e($user->carib_id); ?></b></span></a>
...
<?php /**PATH /home/lubypay/public_html/develop/resources/views/user_dashboard/layouts/app.blade.php ENDPATH**/ ?>