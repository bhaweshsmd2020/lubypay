...
<?php $__env->startSection('title', 'Unlink Device'); ?>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if(!empty($user_log->local_trans_time) && $user_log->local_trans_time): ?> <?php echo e(Carbon\Carbon::parse($user_log->local_trans_time)->format('d-M-Y h:i A')); ?> <?php endif; ?></td>
                                        <td>
                                            <?php if($user->request_device == '0'): ?>
                                                <a href="<?php echo e(url('admin/approve-device/' . $user->id)); ?>" class="label label-danger delete-warning"><i class="glyphicon glyphicon-trash" data-toggle="tooltip" title="Clear Device"></i> Clear Device</a>&nbsp;
                                            <?php endif; ?>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lubypay/public_html/accounts/resources/views/admin/users/unlinkdevice.blade.php ENDPATH**/ ?>