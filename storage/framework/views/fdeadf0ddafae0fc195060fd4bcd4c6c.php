    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                    ...
                    <form action="<?php echo e(url('admin/banner/update')); ?>" class="form-horizontal" id="user_form" method="POST" enctype="multipart/form-data">
                       
                        <input type="hidden" value="<?php echo e(csrf_token()); ?>" name="_token" id="token">
                        <input type="hidden" value="<?php echo e($banners->banner_id); ?>" name="id" id="id">
                        <input type="hidden" value="<?php echo e($banners->banner_id); ?>" name="old_banner_image" id="old_banner_image">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if($banners->banner_image){?>
                                             <img src="<?php echo e(url('public/uploads/banner/'.$banners->banner_image)); ?>" class="img-responsive" style="width:100%;height:150px">
                                            <br>
                                    <?php }?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" placeholder="Banner Title" name="banner_title" type="text" id="banner_title" value="<?php echo e($banners->banner_title); ?>">
                                        </input>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea class="form-control" name="banner_text" id="banner_text"><?php echo e($banners->banner_text); ?></textarea>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="select2" name="app_redirect" id="app_redirect">
                                            <option value='0' <?php echo e(($banners->app_redirect=='0') ? 'selected' :''); ?>>None</option>
                                            <option value='1' <?php echo e(($banners->app_redirect=='1') ? 'selected' :''); ?>>App Page</option>
                                            <option value='2' <?php echo e(($banners->app_redirect=='2') ? 'selected' :''); ?>>Redirect URL</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="select2" name="app_page" id="app_page">
                                            ...
                                            <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value='<?php echo e($page->id); ?>' <?php echo e(($page->id ==$banners->app_page) ? 'selected' :''); ?>><?php echo e($page->page_name); ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" name="redirect_url" id="redirect_url"><?php echo e($banners->redirect_url); ?></input>
                                        <?php if($errors->has('banner_text')): ?>
                                            <span class="error">
                                                <?php echo e($errors->first('banner_text')); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="select2" name="position" id="position">
                                            <option value='Top' <?php echo e(($banners->position=='Top') ? 'selected' :''); ?>>Top</option>
                                            <option value='Bottom' <?php echo e(($banners->position=='Bottom') ? 'selected' :''); ?>>Bottom</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="select2" name="platform" id="platform">
                                            <option value='ewallet' <?php echo e(($banners->platform=='ewallet') ? 'selected' :''); ?>>Ewallet</option>
                                            <option value='mpos' <?php echo e(($banners->platform=='mpos') ? 'selected' :''); ?>>Mpos</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <!-- Language -->
                                    ...
                                    <div class="col-sm-6">
                                        <select class="select2" name="language" id="language" required>
                                            <?php $__currentLoopData = $language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <option value="<?php echo e($value->id); ?>" <?php if($value->id==$banners->language): ?> selected  <?php endif; ?>><?php echo e($value->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="select2" name="status" id="status">
                                            <option value='Active' <?php echo e(($banners->status=='Active') ? 'selected' :''); ?>>Active</option>
                                            <option value='Inactive' <?php echo e(($banners->status=='Inactive') ? 'selected' :''); ?>>Inactive</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="box-footer">
                                    <a class="btn btn-danger btn-flat pull-left" href="<?php echo e(url('admin/banner')); ?>" id="users_cancel">Cancel</a>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lubypay/public_html/develop/resources/views/admin/banner/edit.blade.php ENDPATH**/ ?>