...
<?php $__env->startSection('page_content'); ?>
    ...
    <div class="box">
        <div class="box-body">
            <form class="form-horizontal" action="<?php echo e(url('admin/transfers')); ?>" method="GET">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control select2" name="currency" id="currency">
                                    ...
                                    <?php $__currentLoopData = $transfer_currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transfer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($transfer->currency_id); ?>" <?php echo e(($transfer->currency_id == $currency) ? 'selected' : ''); ?>>
                                            <?php echo e($transfer->currency->code); ?>
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control select2" name="status" id="status">
                                    ...
                                    <?php $__currentLoopData = $transfer_status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transfer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <option value="<?php echo e($transfer->status); ?>" <?php echo e(($transfer->status == $status) ? 'selected' : ''); ?>>
                                        <?php echo e((
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $transfers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e(formatNumber($deposit->fee)); ?></td>
                                        <td><?php echo e(formatNumber($deposit->fee + $deposit->amount)); ?></td>
                                        ...
                                        <td>
                                            <?php if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_transfer')): ?>
                                                <a href="<?php echo e(url('admin/transfers/edit/' . $deposit->id)); ?>" class="label label-primary"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/admin/transfers/list.blade.php ENDPATH**/ ?>