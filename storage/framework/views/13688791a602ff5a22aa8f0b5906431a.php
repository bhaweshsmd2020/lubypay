...
<?php $__env->startSection('title', 'Photo Verification'); ?>
<?php $__env->startSection('page_content'); ?>
    ...
    <div class="box">
        <div class="box-body">
            <form class="form-horizontal" action="<?php echo e(url('admin/photo-proofs')); ?>" method="GET">
                                    ...
                                    <tr>
                                        ...
                                        <td class=" dt-center">
                                            <?php if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_identity_verfication')): ?>
                                                <a href="<?php echo e(url('admin/photo-proofs/edit/' . $document->id)); ?>" class="label label-primary"><i class="glyphicon glyphicon-edit"></i></a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/admin/verifications/photo_proofs/list.blade.php ENDPATH**/ ?>