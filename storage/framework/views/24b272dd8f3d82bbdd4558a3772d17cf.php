    ...
    <div class="box-body no-padding" style="display: block;">
        <ul class="nav nav-pills nav-stacked">
            ...
            <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-34' ? 'class=active' : ''); ?> >
                <a href="<?php echo e(URL::to("admin/notification/template/34")); ?>">Clear Device</a>
            </li>
        </ul>
    </div>
</div>
    ...
    <div class="box-body no-padding" style="display: block;">
        <ul class="nav nav-pills nav-stacked">
            ...
            <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-35' ? 'class=active' : ''); ?> >
                <a href="<?php echo e(URL::to("admin/notification/template/35")); ?>">Video Verification</a>
            </li>
            ...
            <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-33' ? 'class=active' : ''); ?> >
                <a href="<?php echo e(URL::to("admin/notification/template/33")); ?>">Clear Device</a>
            </li>
        </ul>
    </div>
</div><?php /**PATH /home/lubypay/public_html/accounts/resources/views/admin/common/notification_menu.blade.php ENDPATH**/ ?>