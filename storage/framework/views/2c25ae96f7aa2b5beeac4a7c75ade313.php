...
$(document).on('click', '.trxn', function (e)
{
    ...
    $.ajax(
    {
        ...
        beforeSend: function() {
            $("#status_" + trans_id).text("<?php echo e(__("Cancelling...")); ?>");
            $("#btn_" + trans_id).attr("disabled", true).text("<?php echo e(__("Cancelling...")); ?>");
            $('.trxn_accept').hide();
        },
    })
    .done(function(data)
    {
        ...
        $("#status_" + trans_id).text("<?php echo e(__("Cancelled")); ?>");
        $("#btn_" + trans_id).text("<?php echo e(__("Cancelled")); ?>");
...
$(document).on('click', '.trxn_accept', function (e)
{
    ...
    .then(res =>
    {
        ...
        else
        {
            ...
            if (res == "Suspended")
            {
                window.location.href="<?php echo e(url('check-request-creator-suspended-status')); ?>";
            }
            else if(res == "Inactive")
            {
                window.location.href="<?php echo e(url('check-request-creator-inactive-status')); ?>";
            }
            return false;
        }
    })
...
$(document).on('click', '.sync-crypto-balance', function (e)
{
    $.ajax(
    {
        ...
        {
            //TODO: translation
            swal("<?php echo e(__('Please Wait')); ?>", "<?php echo e(__('Syncing Balance...')); ?>", {
...
</script><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/common/user-transactions-scripts.blade.php ENDPATH**/ ?>