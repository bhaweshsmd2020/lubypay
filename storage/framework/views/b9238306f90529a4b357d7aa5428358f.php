  ...
  <div class="row">
      ...
      <div class="col-md-9">
        ...
        <div class="box box-info">
          ...
          <!-- form start -->
          <form method="POST" action="<?php echo e(url('admin/settings/add_role')); ?>" class="form-horizontal" id="roles_add_form">
              ...
              <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input type="text" name="display_name" class="form-control" value="<?php echo e(old('display_name')); ?>" placeholder="Display Name">
                      <?php if($errors->has('display_name')): ?>
                        <span class="help-block">
                          <strong class="text-danger"><?php echo e($errors->first('display_name')); ?></strong>
                        </span>
                      <?php endif; ?>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <textarea name="description" placeholder="Description" rows="3" class="form-control" value="<?php echo e(old('description')); ?>"></textarea>
                          ...
                          <div class="table-responsive">
                              <table class="table table-bordered">
                                ...
                                <tbody>
                                  ...
                                  <?php $__currentLoopData = $perm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr data-rel="<?php echo e($i); ?>">
                                      ...
                                      <?php $__currentLoopData = $value; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          ...
                                          <input type="hidden" value="<?php echo e($v['id']); ?>" name="id" id="id">
                                          ...
                                          <?php if(isset($v['display_name'])): ?>
                                            <td>
                                              ...
                                              <label class="checkbox-container">
                                                ...
                                                <input type="checkbox" name="permission[]" id="<?php echo e('view_'.$i); ?>" value="<?php echo e($v['id']); ?>"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lubypay/public_html/develop/resources/views/admin/roles/add.blade.php ENDPATH**/ ?>