...
<div class="box box-primary">
  ...
  <div class="box-body no-padding" style="display: block;">
    <ul class="nav nav-pills nav-stacked">
      ...
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-56' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/56")); ?>">Card Transfer (Sender)</a>
      </li>
      
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-60' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/60")); ?>">Card Transfer (Receiver)</a>
      </li>
...
<div class="box box-primary">
  ...
  <div class="box-body no-padding" style="display: block;">
    <ul class="nav nav-pills nav-stacked">
      ...
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-59' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/59")); ?>">Card Transfer</a>
      </li>
      
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-66' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/66")); ?>">Card Subscription</a>
      </li>
...
</div><?php /**PATH /home/lubypay/public_html/sandbox/resources/views/admin/common/mail_menu.blade.php ENDPATH**/ ?>