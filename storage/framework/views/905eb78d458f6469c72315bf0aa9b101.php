                        ...
                        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $user = DB::table('users')->where('email', $card['email'])->first();
                                        if(!empty($user)){
                                    ...
                                    <tr>
                                        <td><?php echo e(++$k); ?></td>
                                        <td><a href="<?php echo e($url); ?>"><?php echo e($card['first_name']); ?></a></td>
                                        <td><?php echo e($card['email']); ?></td>
                                        <td><?php echo e($card['phone']); ?></td>
                                        <td>
                                            <?php if($card['request_status'] == 'APPROVED'): ?>
                                                <span class="label label-success">Assigned</span>
                                            <?php elseif($card['request_status'] == 'PENDING'): ?>
                                                <span class="label label-primary">Not Assigned</span>
                                            <?php else: ?>
                                        ...
                                        <td>
                                            <?php if($card['applied_from'] == 'web'): ?>
                                                <span class="label label-success">Web</span>
                                            <?php elseif($card['applied_from'] == 'app'): ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lubypay/public_html/sandbox/resources/views/admin/cards/cardholders.blade.php ENDPATH**/ ?>