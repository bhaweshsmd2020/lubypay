								...
								<form class="form-horizontal">
										...
										<div class="panel panel-default">
											<div class="panel-body">
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
													  <p class="form-control-static"><?php echo e($transaction->from_card); ?></p>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
													  <p class="form-control-static"><?php echo e($transaction->to_card); ?></p>
													</div>
												</div>
									...
									<div class="row">
										<div class="col-md-11">
											...
											<div class="col-md-2"><a id="cancel_anchor" class="btn btn-danger pull-left" href="<?php echo e(url('admin/card/transfers')); ?>">Cancel</a></div>
										</div>
									</div>
								</form>
							</div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/admin/cards/transferdetails.blade.php ENDPATH**/ ?>