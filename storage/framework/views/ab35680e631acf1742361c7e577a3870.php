                                ...
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(!empty($user->picture)): ?>
                                                <a href="<?php echo e(url('admin/users/edit/' . $user->id)); ?>">
                                                    <img src="<?php echo e(url('public/user_dashboard/profile/' . $user->picture)); ?>" style="width: 40px; height: 40px; border-radius: 50%;">
                                                </a>
                                            <?php else: ?>
                                                <a href="<?php echo e(url('admin/users/edit/' . $user->id)); ?>">
                                        ...
                                        <td>
                                            ...
                                            <?php if(empty($user->card_user_id)): ?>
                                                <a href="<?php echo e(url('admin/users/card/kyc/' . $user->id)); ?>" class="label label-success"><i class="glyphicon glyphicon-user" data-toggle="tooltip" title="Card KYC"></i> Card KYC</a>
                                            <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lubypay/public_html/develop/resources/views/admin/users/index.blade.php ENDPATH**/ ?>