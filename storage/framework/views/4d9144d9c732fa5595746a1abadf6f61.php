...
<?php $__env->startSection('page_content'); ?>
    ...
    <div class="box">
        <div class="box-body">
            <form class="form-horizontal" action="<?php echo e(url('admin/mpos')); ?>" method="GET" id='transaction_form'>
                                ...
                                <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if($transaction->transaction_type_id != '2' || ($transaction->transaction_type_id == '2' && $transaction->pay_type == '2')): ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($transaction->store_fee); ?></td>
                                            ...
                                            <td><a href="<?php echo e(url('admin/users/edit/' . $transaction->end_user_id)); ?>"><?php echo e($receiver); ?></a></td>
                                            <td>
                                            ...
                                            <td>
                                                <?php if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_mpos_transactions')): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/admin/mpos/index.blade.php ENDPATH**/ ?>