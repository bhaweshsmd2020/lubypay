...
<?php $__env->startSection('page_content'); ?>
    ...
    <div class="box">
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
                    <form action='<?php echo e(url("admin/update-profile", $admin_id)); ?>' method="POST" class="form-horizontal" enctype="multipart/form-data" id="profile_form">
                        <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lubypay\resources\views/admin/profile/profile.blade.php ENDPATH**/ ?>