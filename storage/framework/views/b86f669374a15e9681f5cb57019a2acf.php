                ...
                <form action="<?php echo e(url('admin/settings/api_informations')); ?>" method="post" class="form-horizontal" id="api-credentials" >
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="text" name="captcha_secret_key" class="form-control" value="<?php echo e($recaptcha['secret_key']); ?>" placeholder="captcha secret key">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="text" name="captcha_site_key" class="form-control" value="<?php echo e($recaptcha['site_key']); ?>" placeholder="captcha site key">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="text" name="firebase_key" class="form-control" value="<?php echo e($recaptcha['firebase_key']); ?>" placeholder="Firebase key">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lubypay/public_html/sandbox/resources/views/admin/settings/api_credentials.blade.php ENDPATH**/ ?>