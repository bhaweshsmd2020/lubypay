...
<?php $__env->startSection('page_content'); ?>
    ...
    <div class="box">
        <div class="box-body">
            <form class="form-horizontal" action="<?php echo e(url('admin/report')); ?>" method="GET">
    ...
    <div class="box">
        <div class="box-body">
            <div class="row">
                <div class="col-md-4">
                    <h4 class="text-center">TickTapPay Revenue</h4>
                    <?php $__currentLoopData = $currency_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$revenue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div style="min-height: 45px; background: #122d83; border-radius: 5px; padding: 7px 18px; color: white; font-size: 23px; margin-bottom: 15px;">
                            <div style="width:60%;float: left;">
                                <div style="min-height: 25px;"><?php echo e($index); ?></div><div class="clearfix"></div>
                                <div class="clearfix"></div>
                            </div>
                            <div style="width:40%;float: left;text-align: right;">
                                <?php echo e(formatNumber($transactional_revenue)); ?>
                ...
                <div class="col-md-4">
                    <h4 class="text-center">Support Maintainance Fees</h4>
                    <?php $__currentLoopData = $currency_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$revenue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>Total</th>
                                    <th>Currency</th>
                                    <th>TicktapPay Revenue</th>
                                    <th>Support Maintenance Fee</th>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($report->uuid); ?></td>
                                        <td><?php echo e(Carbon\Carbon::parse($local_time)->format('d-M-Y h:i A')); ?></td>
                                        <td><a href="<?php echo e(url('admin/users/edit/' . $senders->id)); ?>"><?php echo e($senders->first_name.' '.$senders->last_name); ?></a></td>
                                        <td><?php echo e(($report->transaction_type->name == "Withdrawal") ? "Payout" : str_replace('_', ' ', $report->transaction_type->name)); ?></td>
                                        <td><?php echo e(($report->charge_percentage == 0) ?  '-' : formatNumber($report->charge_percentage)); ?></td>
                                        <td><?php echo e(($report->charge_fixed == 0) ?  '-' : formatNumber($report->charge_fixed)); ?></td>
                                        <td><?php echo e(($report->charge_percentage == 0) && ($report->charge_fixed == 0) ? '-' : $report->charge_percentage + $report->charge_fixed); ?></td>
                                        <td><?php echo e($report->currency->code); ?></td>
                                        <td><?php echo e($transactional_revenue); ?></td>
                                        <td><?php echo e($operational_revenue); ?></td>
                                        <td><?php echo e($operationala_revenue); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                        </table>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/admin/reports/index.blade.php ENDPATH**/ ?>