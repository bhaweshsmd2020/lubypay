...
<?php $__env->startSection('title', 'Currency Payment Methods'); ?>
	    ...
	    <div class="dropdown">
	        ...
	        <ul class="dropdown-menu">
	          <?php $__currentLoopData = $currencyList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currencyItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	            <li class="listItem" data-rel="<?php echo e($currencyItem->id); ?>">
			...
			<div class="box box-primary">
				...
				<div class="box-body no-padding" style="display: block;">
					<ul class="nav nav-pills nav-stacked">
						<?php $__currentLoopData = $paymentMethodList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paymentMethodItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<li <?php echo e(isset($list_menu) && $list_menu == $paymentMethodItem->slug ? 'class=active' : ''); ?>>
								<a data-spinner="true" href="<?php echo e(url('admin/settings/payment-methods/'.$paymentMethodItem->slug.'/'.$currency->id)); ?>">
									<?php echo e($paymentMethodItem->name); ?>
		...
		<div class="col-md-9">
			<div class="box box-info">
				<div class="box-header with-border text-center">
					<h3 class="box-title"><?php echo e(ucwords($list_menu)); ?> Settings</h3>
				</div>

				<form action='<?php echo e(url('admin/settings/payment-methods/update-paymentMethod-Credentials')); ?>' class="form-horizontal" method="POST" id="currencyPaymentMethod_form">
					<?php echo csrf_field(); ?>
					...
					<div class="box-body">
						...
						<?php if($list_menu == 'stripe'): ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<select class="form-control" name="stripe_status" id="stripe_status">
										...
										<option value='Active' <?php echo e(isset($currencyPaymentMethod->activated_for) && $currencyPaymentMethod->activated_for == json_encode(['deposit' => '']) ? 'selected':""); ?>>Active</option>
										<option value='Inactive' <?php echo e(isset($currencyPaymentMethod->activated_for) &&  $currencyPaymentMethod->activated_for == json_encode(['' => '']) ? 'selected':""); ?>>Inactive</option>
									</select>
								</div>
							</div>
							<div class="clearfix"></div>
							...
							<div class="box-footer">
								<a id="cancel_anchor" href="<?php echo e(url("admin/settings/currency")); ?>" class="btn btn-danger btn-flat">Cancel</a>
								<button type="submit" class="btn btn-primary btn-flat" id="paymentMethodList_update" style="margin-left: -30%;">
									<i class="fa fa-spinner fa-spin" style="display: none;"></i> <span id="paymentMethodList_update_text">Update</span>
								</button>
							</div>

						<?php elseif($list_menu == 'paypal'): ?>
							<!-- paypal - Client ID -->
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->client_id : ''); ?>" id="paypal_client_id">

									<?php if($errors->has('paypal[client_id]')): ?>
									<span class="help-block">
										<strong><?php echo e($errors->first('paypal[client_id]')); ?></strong>
									</span>
									<?php endif; ?>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->client_secret : ''); ?>" id="paypal_client_secret">
									<?php if($errors->has('paypal[client_secret]')): ?>
									<span class="help-block">
										<strong><?php echo e($errors->first('paypal[client_secret]')); ?></strong>
									</span>
									<?php endif; ?>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<select class="form-control" name="paypal[mode]" id="paypal_mode">
										...
										<option value='sandbox' <?php echo e(isset($currencyPaymentMethod->method_data) && (json_decode($currencyPaymentMethod->method_data)->mode) == 'sandbox' ? 'selected':""); ?> >sandbox</option>
										<option value='live' <?php echo e(isset($currencyPaymentMethod->method_data) && (json_decode($currencyPaymentMethod->method_data)->mode) == 'live' ? 'selected':""); ?> >live</option>
									</select>
								</div>
							</div>
							<div class="clearfix"></div>
						...
						<?php elseif($list_menu == 'twoCheckout'): ?>
							<!-- 2Checkout - Seller ID -->
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->seller_id : ''); ?>" id="twoCheckout_seller_id">
									<?php if($errors->has('twoCheckout[seller_id]')): ?>
									<span class="help-block">
										<strong><?php echo e($errors->first('twoCheckout[seller_id]')); ?></strong>
									</span>
									<?php endif; ?>
								</div>
							</div>
						...
						<?php elseif($list_menu == 'payUMoney'): ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->key : ''); ?>" id="payUMoney_key">
									<?php if($errors->has('payUMoney[key]')): ?>
									<span class="help-block">
										<strong><?php echo e($errors->first('payUMoney[key]')); ?></strong>
									</span>
									<?php endif; ?>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->salt : ''); ?>" id="payUMoney_salt">
									<?php if($errors->has('payUMoney[salt]')): ?>
									<span class="help-block">
										<strong><?php echo e($errors->first('payUMoney[salt]')); ?></strong>
									</span>
									<?php endif; ?>
								</div>
							</div>
						...
						<?php elseif($list_menu == 'coinPayments'): ?>
						...
						<?php elseif($list_menu == 'Payeer'): ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->merchant_id : ''); ?>" id="payeer_merchant_id">
									<?php if($errors->has('payeer[merchant_id]')): ?>
									<span class="help-block">
										<strong><?php echo e($errors->first('payeer[merchant_id]')); ?></strong>
									</span>
									<?php endif; ?>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->secret_key : ''); ?>" id="payeer_secret_key">
									<?php if($errors->has('payeer[secret_key]')): ?>
									<span class="help-block">
										<strong><?php echo e($errors->first('payeer[secret_key]')); ?></strong>
									</span>
									<?php endif; ?>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->encryption_key : ''); ?>" id="payeer_encryption_key">
									<?php if($errors->has('payeer[encryption_key]')): ?>
									<span class="help-block">
										<strong><?php echo e($errors->first('payeer[encryption_key]')); ?></strong>
									</span>
									<?php endif; ?>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									<?php if($errors->has('payeer[merchant_domain]')): ?>
									<span class="help-block">
										<strong><?php echo e($errors->first('payeer[merchant_domain]')); ?></strong>
									</span>
									<?php endif; ?>
								</div>
							...
							<div class="box-footer">
								<a id="cancel_anchor" href="<?php echo e(url("admin/settings/currency")); ?>" class="btn btn-danger btn-flat">Cancel</a>
								<button type="submit" class="btn btn-primary btn-flat pull-right" id="paymentMethodList_update" style="margin-right: 40%;margin-top: -3.5%;">
                                    <i class="fa fa-spinner fa-spin" style="display: none;"></i> <span id="paymentMethodList_update_text">Update</span>
								</button>
							</div>
						<?php elseif($list_menu == 'braintree'): ?>
							<!-- Braintree - Public Key -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="braintree[public_key]">Public Key</label>
								<div class="col-sm-5">

									<input class="form-control" name="braintree[public_key]" type="text" placeholder="Braintree Public Key"
									value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->public_key : ''); ?>" id="braintree_public_key">

									<?php if($errors->has('braintree[public_key]')): ?>
									<span class="help-block">
										<strong><?php echo e($errors->first('braintree[public_key]')); ?></strong>
									</span>
									<?php endif; ?>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="braintree[private_key]">Private Key</label>
								<div class="col-sm-5">

									<input class="form-control" name="braintree[private_key]" type="text" placeholder="Braintree Private Key"
									value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->private_key : ''); ?>" id="braintree_private_key">

									<?php if($errors->has('braintree[private_key]')): ?>
									<span class="help-block">
										<strong><?php echo e($errors->first('braintree[private_key]')); ?></strong>
									</span>
									<?php endif; ?>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="braintree[merchant_id]">Merchant ID</label>
								<div class="col-sm-5">

									<input class="form-control" name="braintree[merchant_id]" type="text" placeholder="Braintree Merchant ID"
									value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->merchant_id : ''); ?>" id="braintree_merchant_id">

									<?php if($errors->has('braintree[merchant_id]')): ?>
									<span class="help-block">
										<strong><?php echo e($errors->first('braintree[merchant_id]')); ?></strong>
									</span>
									<?php endif; ?>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="processing_time">Processing Time (days)</label>
								<div class="col-sm-5">
									<input class="form-control" name="processing_time" type="text" placeholder="Braintree Processing Time"
									value="<?php echo e(isset($currencyPaymentMethod->processing_time) ? $currencyPaymentMethod->processing_time : ''); ?>" id="processing_time">
							...
							<!-- Braintree - Status -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="braintree_status">Status</label>
								<div class="col-sm-5">
									<select class="form-control" name="braintree_status" id="braintree_status">
										<option value=''>Select Status</option>
										<option value='Active' <?php echo e(isset($currencyPaymentMethod->activated_for) && $currencyPaymentMethod->activated_for == json_encode(['deposit' => '']) ? 'selected':""); ?>>Active</option>
										<option value='Inactive' <?php echo e(isset($currencyPaymentMethod->activated_for) &&  $currencyPaymentMethod->activated_for == json_encode(['' => '']) ? 'selected':""); ?>>Inactive</option>
									</select>
						...
						<?php elseif($list_menu == 'ach'): ?>
							<!-- Stripe - Secret Key -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="ach[ach_stripe_secret_key]">Stripe Secret Key</label>
								<div class="col-sm-5">
									<input class="form-control" name="ach[ach_stripe_secret_key]" type="text" placeholder="Stripe Secret Key" value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->ach_stripe_secret_key : ''); ?>" id="ach_stripe_secret_key">
									<?php if($errors->has('ach[ach_stripe_secret_key]')): ?>
    									<span class="help-block">
    										<strong><?php echo e($errors->first('ach[ach_stripe_secret_key]')); ?></strong>
    									</span>
									<?php endif; ?>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input class="form-control" name="ach[ach_stripe_publishable_key]" type="text" placeholder="Stripe Publishable Key" value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->ach_stripe_publishable_key : ''); ?>" id="ach_stripe_publishable_key">
									<?php if($errors->has('ach[ach_stripe_publishable_key]')): ?>
    									<span class="help-block">
    										<strong><?php echo e($errors->first('ach[ach_stripe_publishable_key]')); ?></strong>
    									</span>
									<?php endif; ?>
								</div>
							</div>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input class="form-control" name="ach[ach_stripe_webhook_secret]" type="text" placeholder="Stripe Webhook Secret" value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->ach_stripe_webhook_secret : ''); ?>" id="ach_stripe_webhook_secret">
                                    <?php if($errors->has('ach[ach_stripe_webhook_secret]')): ?>
                                        <span class="help-block">
                                            <strong><?php echo e($errors->first('ach[ach_stripe_webhook_secret]')); ?></strong>
                                        </span>
                                    <?php endif; ?>
                                </div>
                            </div>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input class="form-control" name="ach[ach_base_url]" type="text" placeholder="ACH Base URL" value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->ach_base_url : ''); ?>" id="ach_base_url">
                                    <?php if($errors->has('ach[ach_base_url]')): ?>
                                        <span class="help-block">
                                            <strong><?php echo e($errors->first('ach[ach_base_url]')); ?></strong>
                                        </span>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input class="form-control" name="ach[ach_client_id]" type="text" placeholder="ACH Client Id" value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->ach_client_id : ''); ?>" id="ach_client_id">
                                    <?php if($errors->has('ach[ach_client_id]')): ?>
                                        <span class="help-block">
                                            <strong><?php echo e($errors->first('ach[ach_client_id]')); ?></strong>
                                        </span>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input class="form-control" name="ach[ach_client_secret]" type="text" placeholder="ACH Client Secret" value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->ach_client_secret : ''); ?>" id="ach_client_secret">
                                    <?php if($errors->has('ach[ach_client_secret]')): ?>
                                        <span class="help-block">
                                            <strong><?php echo e($errors->first('ach[ach_client_secret]')); ?></strong>
                                        </span>
                                    <?php endif; ?>
                                </div>
                            </div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="processing_time">Processing Time (days)</label>
								<div class="col-sm-5">
									<input class="form-control" name="processing_time" type="text" placeholder="Stripe Processing Time" value="<?php echo e(isset($currencyPaymentMethod->processing_time) ? $currencyPaymentMethod->processing_time : ''); ?>" id="processing_time">
									<?php if($errors->has('processing_time')): ?>
    									<span class="help-block">
    										<strong><?php echo e($errors->first('processing_time')); ?></strong>
    									</span>
				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1">
					    ...
					    <input type="hidden" id="getuser_id" value="<?php echo e(\Auth::guard('admin')->user()->id); ?>">
											...
											<div class="col-md-5">
												<div class="form-group">
													...
													<div class="preview_bank_logo">
														<img src="<?php echo e(url('public/uploads/userPic/default-image.png')); ?>" width="120" height="80" id="bank-demo-logo-preview"/>
													</div>
												</div>
											</div>
										</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
    	$('#addModal').on('hidden.bs.modal', function (e) {
            ...
            $('#bank_logo').val('');
            $('#bank-demo-logo-preview').attr({src: '<?php echo e(url('public/uploads/userPic/default-image.png')); ?>'});
	    });
    ...
    function handleFileSelectEdit()
    {
	    ...
	    if (input.files && input.files.length)
	    {
	        ...
	        reader.onload = (function (e)
	        {
		        ...
		        if (!input.files[0].name.match(/.(png|jpg|jpeg|gif|bmp|ico)$/i))
		        {
		        	$('.thumb-bank-logo').attr({src: '<?php echo e(url('public/uploads/userPic/default-image.png')); ?>'});
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lubypay\resources\views/admin/currencyPaymentMethod/list.blade.php ENDPATH**/ ?>