...
<div class="box box-primary">
  ...
  <div class="box-body no-padding" style="display: block;">
    <ul class="nav nav-pills nav-stacked">
      ...
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-61' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/61")); ?>">New User</a>
      </li>
      ...
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-65' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/65")); ?>">Card Subscription</a>
      </li>
      
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-68' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/68")); ?>">Subscription Expiry</a>
      </li>
      
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-66' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/66")); ?>">Renew Subscription</a>
      </li>
      
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-73' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/73")); ?>">Upgrade Subscription</a>
      </li>
      
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-54' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/54")); ?>">Card Request</a>
      </li>

      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-55' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/55")); ?>">Card Reload</a>
      </li>
      
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-70' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/70")); ?>">Card Status</a>
      </li>
      
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-67' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/67")); ?>">Maintenance Break</a>
      </li>
      
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-75' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/75")); ?>">ACH Transfer Request</a>
      </li>
      
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-77' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/77")); ?>">ACH Transfer Complete</a>
      </li>
  ...
  <div class="box-body no-padding" style="display: block;">
    <ul class="nav nav-pills nav-stacked">
      ...
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-8' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/8")); ?>">Request Payments (Success/Refund)</a>
      </li>
...
<div class="box box-primary">
  ...
  <div class="box-body no-padding" style="display: block;">
    <ul class="nav nav-pills nav-stacked">
      ...
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-63' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/63")); ?>">Ewallet New User</a>
      </li>
      
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-64' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/64")); ?>">mPOS New User</a>
      </li>
      ...
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-69' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/69")); ?>">Card Subscription</a>
      </li>
      
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-72' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/72")); ?>">Renew Subscription</a>
      </li>
      
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-74' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/74")); ?>">Upgrade Subscription</a>
      </li>
      
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-57' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/57")); ?>">Card Request</a>
      </li>

      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-58' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/58")); ?>">Card Reload</a>
      </li>
      
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-71' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/71")); ?>">Card Status</a>
      </li>
      
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-76' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/76")); ?>">ACH Transfer Request</a>
      </li>
      
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-78' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/78")); ?>">ACH Transfer Complete</a>
      </li>
    </ul>
  </div>
</div>
...
<div class="box box-primary">
  ...
  <div class="box-body no-padding" style="display: block;">
    <ul class="nav nav-pills nav-stacked">
      ...
      <li <?php echo e(isset($list_menu) &&  $list_menu == 'menu-62' ? 'class=active' : ''); ?> >
        <a href="<?php echo e(URL::to("admin/template/62")); ?>">New User</a>
      </li>
...
</div><?php /**PATH /home/lubypay/public_html/develop/resources/views/admin/common/mail_menu.blade.php ENDPATH**/ ?>