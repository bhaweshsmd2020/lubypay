                        ...
                        <input type="hidden" value="<?php echo e(csrf_token()); ?>" name="_token" id="token">
                            ...
                            <div class="box-body">
                                ...
                                <div class="box-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary pull-right btn-flat" id="banner_create"><i class="fa fa-spinner fa-spin" style="display: none;"></i> <span id="users_create_text">Create</span></button>
                                </div>
                            </div>
                        </input>
                    </form>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lubypay/public_html/develop/resources/views/admin/banner/add.blade.php ENDPATH**/ ?>