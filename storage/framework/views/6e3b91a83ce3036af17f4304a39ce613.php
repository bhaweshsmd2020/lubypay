                                ...
                                <form action="<?php echo e(url('register/store')); ?>" class="form-horizontal" id="register_form" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="role" id="type">
                                          <?php if(!empty($checkUserRole)): ?>
                                            <option value='2'><?php echo app('translator')->get('message.registration.type-user'); ?></option>
                                          <?php endif; ?>
                                          <?php if(!empty($checkMerchantRole)): ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/frontend/auth/register.blade.php ENDPATH**/ ?>