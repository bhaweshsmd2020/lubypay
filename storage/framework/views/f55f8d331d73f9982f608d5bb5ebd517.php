                    ...
                    <select name="wallet" id="wallet" class="form-control" onChange="getwallet();" style="width: 200px;">
                        <?php $__currentLoopData = $wallets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wallet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($currency->id == $wallet->currency_id): ?>
                                    <option value="<?php echo e($wallet->id); ?>" <?php if($currency->id == '7'){ echo 'selected'; }?>><?php echo e($currency->code); ?></option>
                                <?php endif; ?>
...
$("#getoperator").click(function(){
    ...
    var phone = jQuery('#phone').val();
  	jQuery.ajax({
		url: '<?php echo e(URL::to("/ding-getOperator")); ?>',
		type: "POST",
...
function getoperatorplan() {
    ...
    var carrier_code  = jQuery('#carrierCode').val();
  	jQuery.ajax({
		url: '<?php echo e(URL::to("/ding-getoperatorplan")); ?>',
		type: "POST",
        data: {
...
$("#getvalue").click(function(){
  	jQuery.ajax({
		url: '<?php echo e(URL::to("/ding-getvalue")); ?>',
		type: "POST",
...
$("#confirmvalue").click(function(){
  	jQuery.ajax({
		url: '<?php echo e(URL::to("/ding-confirmvalue")); ?>',
		type: "POST",
        data:$('#amountform').serialize(),
		success: function (result) {
		    console.log(result);
...
function getwallet() {
    ...
    var amount = jQuery('#rec_amount3').val();
  	jQuery.ajax({
		url: '<?php echo e(URL::to("/getwallet")); ?>',
		type: "POST",
        data: {
            "_token": "<?php echo e(csrf_token()); ?>",
            "wallet": wallet,
...
$("#topupsubmit").click(function(){
    ...
    var SendCurrencyIso = jQuery('#SendCurrencyIso').val();
  	...
  	jQuery.ajax({
		url: '<?php echo e(URL::to("/ding-makerecharge")); ?>',
		type: "POST",
		dataType:"JSON",
        data: {
            "_token": "<?php echo e(csrf_token()); ?>",
...
<?php echo $__env->make('user_dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/user_dashboard/dingConnect/index.blade.php ENDPATH**/ ?>