...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7 col-xs-12 mb20 marginTopPlus">
                    ...
                    <form id="depositForm1" action="<?php echo e(url('deposit')); ?>" method="post" accept-charset='UTF-8'>
                        <div class="card">
                            <div class="card-header">
                                <div class="chart-list float-left">
                                    <ul>
                                        <li class=""><?php echo app('translator')->get('message.dashboard.deposit.title'); ?></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="wap-wed mt20 mb20">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="exampleInputPassword1"><?php echo app('translator')->get('message.dashboard.deposit.amount'); ?></label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="exampleInputPassword1"><?php echo app('translator')->get('message.dashboard.deposit.currency'); ?></label>
                                                <select class="form-control wallet" name="currency_id" id="currencies">
                                                    <?php $__currentLoopData = $activeCurrencyList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aCurrency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($aCurrency['id']); ?>"<?php echo e($defaultWallet->currency_id == $aCurrency['id'] ? 'selected="selected"' : ''); ?>><?php echo e($aCurrency['code']); ?></option>
                                        ...
                                        <div class="col-md-12" id="paymentMethodEmpty" style="display: none;">
                                            <div class="form-group">
                                                <label><?php echo app('translator')->get('message.dashboard.deposit.fees-limit-payment-method-settings-inactive'); ?></label>
                                            </div>
                                        </div>
                                        <div class="col-md-12" id="paymentMethodSection">
                                            <div class="form-group">
                                                <label for="exampleInputPassword1"><?php echo app('translator')->get('message.dashboard.deposit.payment-method'); ?></label>
                                ...
                                <div class="" style="margin-bottom: 10px;    padding-left: 15px;">
                                    <button type="submit" class="btn btn-cust col-12 transfer_form ncust" id="deposit-money">
                                        <i class="spinner fa fa-spinner fa-spin" style="display: none;"></i> <span id="deposit-money-text"><?php echo app('translator')->get('message.dashboard.button.next'); ?></span>
                                    </button>
                                </div>
                            </div>
                        </div>
    ...
    <?php echo $__env->make('user_dashboard.layouts.common.help', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    ...
    function getMatchedFeesLimitsCurrencyPaymentMethodsSettingsPaymentMethods(currency_id)
    {
        ...
        $.ajax(
        {
            ...
            data: {
                "_token": token,
                'transaction_type_id': '<?php echo e(Deposit); ?>',
        ...
        }).done(function(response)
        {
            ...
            {
                options += `<option value="${value.id}">${value.pay_name}</option>`;
            });
    ...
    $('#depositForm1').validate(
    {
        ...
        submitHandler: function(form)
        {
            ...
            $("#deposit-money-text").text("<?php echo e(__('Depositing...')); ?>");
            form.submit();
            setTimeout(function()
            {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user_dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/user_dashboard/deposit/create.blade.php ENDPATH**/ ?>