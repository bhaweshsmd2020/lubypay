                    ...
                    <input type="hidden" value="<?php echo e(csrf_token()); ?>" name="_token" id="token">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="french" name="french" value="<?php echo e($allabels->fr); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="haiti" name="haiti" value="<?php echo e($allabels->haiti); ?>">
                                </div>
                            </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lubypay/public_html/accounts/resources/views/admin/labels/edit.blade.php ENDPATH**/ ?>