					...
					<div class="card">
						...
						<div class="wap-wed mt20 mb20">
							<div class="form-group">
								...
								<input value="<?php if(isset($data['name'])){ echo $data['name'];}?>" class="form-control" name="name" id="name"  type="text">
							...
							<div class="form-group">
								...
								<textarea name="description" class="form-control" id="description"><?php if(isset($data['description'])){ echo strip_tags($data['description']);}?></textarea>
							...
							<div class="form-group">
								...
								<input value="<?php if(isset($data['address'])){ echo $data['address'];}?>" class="form-control" name="address" id="address"  type="text">
							...
							<div class="form-group">
								<label>City</label>
								<input value="<?php if(isset($data['city'])){ echo $data['city'];}?>" class="form-control" name="city" id="city" type="text">
							...
							<div class="form-group">
								<label>State</label>
								<input value="<?php if(isset($data['state'])){ echo $data['state'];}?>" class="form-control" name="state" id="state" type="text">
							...
							<div class="form-group">
								...
								<input value="<?php if(isset($data['postalcode'])){ echo $data['postalcode'];}?>" class="form-control" name="postalcode" id="postalcode"  type="text">
							...
							<div class="form-group">
								<label>Tax (%)</label>
								<input value="<?php if(isset($data['tax'])){ echo $data['tax'];}?>" class="form-control" name="tax" id="tax"  type="text">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user_dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lubypay/public_html/develop/resources/views/user_dashboard/Merchant/mystore.blade.php ENDPATH**/ ?>