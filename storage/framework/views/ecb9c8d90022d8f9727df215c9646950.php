                        ...
                        <?php if($disputes): ?>
                            <?php $__currentLoopData = $disputes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dispute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo e(url('admin/dispute/discussion/'.$dispute->id)); ?>"><?php echo e($dispute->code); ?></a></td>

                                    <td><a href="<?php echo e(url('admin/dispute/discussion/'.$dispute->id)); ?>"><?php echo e($dispute->title); ?></a></td>

                                    <td><a href="<?php echo e(url('admin/users/edit/'. $dispute->claimant->id)); ?>"><?php echo e(isset($dispute->claimant) ? $dispute->claimant->first_name.' '.$dispute->claimant->last_name :"-"); ?></a></td>

                                    <td>
                                        <?php if(isset($dispute->transaction)): ?>
                                            <a href="<?php echo e(url('admin/transactions/edit/'.$dispute->transaction->id)); ?>" target="_blank"><?php echo e($dispute->transaction->uuid); ?></a>
                                        <?php else: ?>
                                            <?php echo e('Not Found'); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/admin/users/eachuserdispute.blade.php ENDPATH**/ ?>