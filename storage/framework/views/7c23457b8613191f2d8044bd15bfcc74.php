            ...
            <div class="row">
                ...
                <?php if(Common::has_permission(\Auth::guard('admin')->user()->id, 'add_admin')): ?>
                    <div class="col-md-2 pull-right">
                        <a href="<?php echo e(url('admin/add-admin')); ?>" class="btn btn-success btn-flat"><span class="fa fa-plus"> &nbsp;</span>Add Admin</a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo e(url('admin/edit-admin/' . $admin->id)); ?>"><?php echo e($admin->first_name.' '.$admin->last_name); ?></a></td>
                                        ...
                                        <td>
                                            <?php if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_admin')): ?>
                                                <a href="<?php echo e(url('admin/edit-admin/' . $admin->id)); ?>" class="label label-primary"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;
                                            <?php endif; ?>

                                            <?php if(Common::has_permission(\Auth::guard('admin')->user()->id, 'delete_admin')): ?>
                                                <a href="<?php echo e(url('admin/delete-admin/' . $admin->id)); ?>" class="label label-danger delete-warning"><i class="glyphicon glyphicon-trash"></i></a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lubypay\resources\views/admin/admin/view.blade.php ENDPATH**/ ?>