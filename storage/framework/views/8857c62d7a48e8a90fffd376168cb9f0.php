                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="chart-list float-left">
                                <ul>
                                    ...
                                    <li class="active"><a href="<?php echo e(url('/profile/personal-address')); ?>"><?php echo app('translator')->get('message.personal-address.title'); ?>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <!-- form -->
                                    <form action="<?php echo e(url('profile/personal-address-update')); ?>" method="POST" class="form-horizontal" id="personal_address" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-5">
                                                <label for="address_file"><?php echo app('translator')->get('message.personal-address.upload-address-proof'); ?>(upto 10MB)</label>
                                        ...
                                        <?php if(!empty($documentVerification->file)): ?>
                                            <h5>
                                                <a class="text-info" href="<?php echo e(url('public/uploads/user-documents/address-proof-files').'/'.$documentVerification->file->filename); ?>"><i class="fa fa-download"></i>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-5">
                                                <button type="submit" class="btn btn-cust col-12" id="personal_address_submit">
                                                    <i class="spinner fa fa-spinner fa-spin" style="display: none;"></i> <span id="personal_address_submit_text"><?php echo app('translator')->get('message.dashboard.button.submit'); ?></span>
                                                </button>
                                            </div>
                                        </div>
                                    </form>
...
<?php echo $__env->make('user_dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/user_dashboard/users/personal_address.blade.php ENDPATH**/ ?>