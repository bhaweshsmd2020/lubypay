                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="float-left trans-inline">
                                <?php echo app('translator')->get('message.dashboard.exchange.left-top.title'); ?>
                            </h4>
                        </div>
                        <div class="wap-wed mt20 mb20">
                            <div>
                                <form accept-charset="utf-8" action="<?php echo e(url('exchange-of-money')); ?>" id="exchange1_form" method="post">
                                    ...
                                    <input class="total_amount" name="total_amount" type="hidden" value="0.00">

                                    <!-- From Wallet-->
                                    <div class="form-group">
                                        <div class="col-md-8">
                                            <label id="wallet-label">
                                                <?php echo app('translator')->get('message.dashboard.exchange.left-top.from-wallet'); ?>
                                                <span id="top-balance" style="display: none;">
                                                    (
                                                    <b>
                                                        <?php echo app('translator')->get('message.dashboard.exchange.left-top.balance'); ?>:
                                            ...
                                            <select class="form-control user-wallet" id="user-wallet" name="from_currency_id">
                                                <option value=""><?php echo app('translator')->get('message.dashboard.exchange.left-top.select-wallet'); ?></option>
                                                <?php $__currentLoopData = $activeHasTransactionUserCurrencyList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <small class="form-text text-muted" id="walletlHelp">
                                                <?php echo app('translator')->get('message.dashboard.deposit.fee'); ?>(<span class="pFees">0</span>%+<span
                                                        class="fFees">0</span>)
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-8">
                                            <label id="wallet-label">
                                                <?php echo app('translator')->get('message.dashboard.exchange.left-top.to-wallet'); ?>
                                            ...
                                            <select class="form-control wallet" id="active-currencies" name="currency_id">
                                                <option value="">
                                                    <?php echo app('translator')->get('message.dashboard.exchange.left-top.select-wallet'); ?>
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-8">
                                            <label>
                                                <?php echo app('translator')->get('message.dashboard.exchange.left-top.give-amount'); ?>
                                            </label>
                                        ...
                                        <strong class="text-danger">- <span class="total_fees text-danger"> 0.00</span></strong> Conversion Fee <br>
                                        <strong class="text-success" style="color:green !important"> = <span class="total_amount text-success" style="color:green !important">0.00</span></strong> Amount Converted <br>
                                        <strong>x <span class="exchange_cuur_rate">0.00</span></strong> Rate Used <br><br>
                                    ...
                                    <div class="form-group div_get_amount" style="display: none;text-align: center;">
                                        <div class="col-md-8">
                                            <label>
                                                <?php echo app('translator')->get('message.dashboard.exchange.left-top.get-amount'); ?>
                                            </label>
                                    ...
                                    <div class="form-group text-center mt-2">
                                        <div class="col-md-8">
                                            <div class="buttonPadding pull-right" style="margin-bottom: 10px;margin-top:-25px">
                                                <button class="btn btn-cust" id="exchange-create" type="submit" style="    padding: 5px 12px;">
...
<script type="text/javascript">
        ...
        if (amount > 0 && currency_id)
        {
            $.ajax({
                ...
                data: {
                    ...
                    'transaction_type_id':'<?php echo e(Exchange_From); ?>'
                },
            })
            .done(function (response)
            {
                ...
                if (response.success.status == 200)
                {
                   ...
                   $(".total_fees").val(response.success.totalFees);
                    ...
                    $('.total_amount').html(response.success.totalAmount);

                    //checking wallet balance
                    if ((response.success.totalAmount > response.success.balance) || amount == '')
                    {
                        $('.amountLimit1').html("<?php echo e(__("Not have enough balance !")); ?>");
    ...
    function getCurrenciesExceptUsersExistingWallets(fromWallet)
    {
        ...
        if (currency_id)
        {
            ...
            {
                var options = '';
                options += `<option value=""><?php echo e(__("Select Wallet")); ?></option>`;
                ...
                success: function(response)
                {
                    ...
                    if (response.status == true)
                    {
                        if((amount > 0 || amount != '')  && fromWallet != '' && toWallet != '')
                        {
                            ...
                            $('.exchange_rate').html(`<b> <?php echo e(__("Exchange rate")); ?>: </b>` + `1 ${fromWalletCode} = ` + response.destinationCurrencyRate + ` ${toWalletCode}`);
                            $('.exchange_cuur_rate').html(response.destinationCurrencyRate);
                            $('.div_get_amount').show();
    ...
    $(window).on('load', function()
    {
        ...
        {
            swal("<?php echo e(__('Please Wait')); ?>", "<?php echo e(__('Loading...')); ?>", {
    ...
    $('#exchange1_form').validate({
        ...
        submitHandler: function (form) {
            ...
            $("#exchange-create-text").text("<?php echo e(__('Exchanging...')); ?>");
            form.submit();
            setTimeout(function(){
...
<?php echo $__env->make('user_dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/user_dashboard/exchange/create.blade.php ENDPATH**/ ?>