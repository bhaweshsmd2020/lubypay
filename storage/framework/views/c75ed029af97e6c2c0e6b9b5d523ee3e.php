        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-xs-12 mb20 marginTopPlus">
                    ...
                    <div class="right mb10" style="height: 15px;">
                                ...
                                <table class="table recent_activity">
                                    ...
                                    <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($result->unique_id); ?> </td>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo e(url('orders/detail/'.$result->id)); ?>" class="btn btn-secondary btn-sm"><i class="fa fa-eye"></i></a>
                                                <!--<a href="<?php echo e(url('orders/edit/'.$result->id)); ?>" class="btn btn-sm btn-info"><i class="fa fa-pencil"></i></a>-->
                                            </td>
                                        </tr>
...
<?php echo $__env->make('user_dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/user_dashboard/Order/list.blade.php ENDPATH**/ ?>