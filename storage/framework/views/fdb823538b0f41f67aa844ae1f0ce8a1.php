		...
		<div class="col-md-9">
			<div class="box box-info">
				<div class="box-header with-border text-center">
					<h3 class="box-title">
						<?php if($list_menu == 'twoCheckout'): ?><?php echo e(ucwords(str_replace('two', '2', $list_menu))); ?> Settings
						<?php elseif($list_menu == 'bank'): ?>
						<?php elseif($list_menu == 'cash'): ?>
						<?php echo e("Cash Payment"); ?> Settings
						<?php elseif($list_menu == 'braintree'): ?>
						<?php echo e("Braintree Payment"); ?> Settings
						<?php elseif($list_menu == 'mobile'): ?>
						<?php echo e("Mobile Payment"); ?> Settings
						<?php else: ?><?php echo e(ucfirst($list_menu)); ?> Settings
						<?php endif; ?>
					</h3>
				</div>
				...
				<form action='<?php echo e(url('admin/settings/payment-methods/update-paymentMethod-Credentials')); ?>' class="form-horizontal" method="POST" id="currencyPaymentMethod_form">
					...
					<div class="box-body">
						...
						<?php elseif($list_menu == 'plaid'): ?>
							<!-- Stripe - Secret Key -->
							<div class="form-group">
								<label class="col-sm-3 control-label" for="plaid[plaid_stripe_secret_key]">Stripe Secret Key</label>
								<div class="col-sm-5">
									<input class="form-control" name="plaid[plaid_stripe_secret_key]" type="text" placeholder="Stripe Secret Key" value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->plaid_stripe_secret_key : ''); ?>" id="plaid_stripe_secret_key">
									<?php if($errors->has('plaid[plaid_stripe_secret_key]')): ?>
    									<span class="help-block">
    										<strong><?php echo e($errors->first('plaid[plaid_stripe_secret_key]')); ?></strong>
    									</span>
									<?php endif; ?>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input class="form-control" name="plaid[plaid_stripe_publishable_key]" type="text" placeholder="Stripe Publishable Key" value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->plaid_stripe_publishable_key : ''); ?>" id="plaid_stripe_publishable_key">
									<?php if($errors->has('plaid[plaid_stripe_publishable_key]')): ?>
    									<span class="help-block">
    										<strong><?php echo e($errors->first('plaid[plaid_stripe_publishable_key]')); ?></strong>
    									</span>
									<?php endif; ?>
								</div>
							</div>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input class="form-control" name="plaid[plaid_stripe_webhook_secret]" type="text" placeholder="Stripe Webhook Secret" value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->plaid_stripe_webhook_secret : ''); ?>" id="plaid_stripe_webhook_secret">
                                    <?php if($errors->has('plaid[plaid_stripe_webhook_secret]')): ?>
                                        <span class="help-block">
                                            <strong><?php echo e($errors->first('plaid[plaid_stripe_webhook_secret]')); ?></strong>
                                        </span>
                                    <?php endif; ?>
                                </div>
                            </div>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input class="form-control" name="plaid[plaid_base_url]" type="text" placeholder="Plaid Base URL" value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->plaid_base_url : ''); ?>" id="plaid_base_url">
                                    <?php if($errors->has('plaid[plaid_base_url]')): ?>
                                        <span class="help-block">
                                            <strong><?php echo e($errors->first('plaid[plaid_base_url]')); ?></strong>
                                        </span>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input class="form-control" name="plaid[plaid_client_id]" type="text" placeholder="Plaid Client Id" value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->plaid_client_id : ''); ?>" id="plaid_client_id">
                                    <?php if($errors->has('plaid[plaid_client_id]')): ?>
                                        <span class="help-block">
                                            <strong><?php echo e($errors->first('plaid[plaid_client_id]')); ?></strong>
                                        </span>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input class="form-control" name="plaid[plaid_client_secret]" type="text" placeholder="Plaid Client Secret" value="<?php echo e(isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->plaid_client_secret : ''); ?>" id="plaid_client_secret">
                                    <?php if($errors->has('plaid[plaid_client_secret]')): ?>
                                        <span class="help-block">
                                            <strong><?php echo e($errors->first('plaid[plaid_client_secret]')); ?></strong>
                                        </span>
                                    <?php endif; ?>
                                </div>
                            </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lubypay/public_html/develop/resources/views/admin/currencyPaymentMethod/list.blade.php ENDPATH**/ ?>