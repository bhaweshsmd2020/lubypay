        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">
              ...
              <?php elseif($tempId == 67): ?>
                Maintenance Break Template
                
              <?php elseif($tempId == 68): ?>
                                ...
                                <?php if($language->id == $temp->language_id): ?>
                                    <div id="collapse<?php echo e($language->id); ?>" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <label>Body</label>
                                                <textarea name="<?php echo e($language->short_name); ?>[body]" class="form-control editor" style="height: 300px">
                                                    <?php echo e($temp->body); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lubypay/public_html/sandbox/resources/views/admin/email_templates/index.blade.php ENDPATH**/ ?>