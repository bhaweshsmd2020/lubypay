...
<?php $__env->startSection('page_content'); ?>
  <div class="row">
    ...
    <div class="col-md-9">
      ...
      <div class="box-body">
        <!-- /.box-header -->
        <form action="<?php echo e(url('admin/settings/page/store')); ?>" method="POST" id="page" class="form-horizontal" enctype="multipart/form-data">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input class="form-control" name="name" placeholder="Name" value="<?php echo e(old('name')); ?>" type="text" id="name">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lubypay/public_html/develop/resources/views/admin/pages/add.blade.php ENDPATH**/ ?>