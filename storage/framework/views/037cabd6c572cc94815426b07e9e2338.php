                                ...
                                <div class="col-md-7">
                                    ...
                                    <?php if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_stores')): ?>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <button type="submit" class="btn btn-primary pull-right btn-flat" style="margin-left: 10px;">
                                                    Update
                                                </button>
                                                <a class="btn btn-danger btn-flat pull-right" href="<?php echo e(url('admin/store-list')); ?>">
                                                    Cancel
                                                </a>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lubypay/public_html/sandbox/resources/views/admin/stores/edit.blade.php ENDPATH**/ ?>