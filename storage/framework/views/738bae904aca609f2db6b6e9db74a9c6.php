...
<?php $__env->startSection('page_content'); ?>
    ...
    <div class="box">
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
                    <form action="<?php echo e(url("admin/users/deposit/create/$users->id")); ?>" method="post" accept-charset='UTF-8' id="admin-user-deposit-create">
                        ...
                        <input type="hidden" name="fullname" id="user_id" value="<?php echo e($users->first_name.' '.$users->last_name); ?>">
                                ...
                                <div class="col-md-5" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control payment_method" name="payment_method" id="payment_method">
                                            <?php if($payment_met): ?>
                                            <option value="<?php echo e($payment_met->id); ?>"><?php echo e($payment_met->name); ?></option>
                                            <?php endif; ?>
                                        </select>
                                    </div>
                                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lubypay/public_html/accounts/resources/views/admin/users/deposit/create.blade.php ENDPATH**/ ?>