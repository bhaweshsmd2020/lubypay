<script src="<?php echo e(asset('public/frontend/js/jquery.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/frontend/js/bootstrap.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/frontend/js/jquery.waypoints.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/frontend/js/main.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/frontend/js/moment.js')); ?>" type="text/javascript"></script>
...
<?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/frontend/layouts/common/script.blade.php ENDPATH**/ ?>