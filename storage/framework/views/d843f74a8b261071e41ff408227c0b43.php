...
<div class="box box-default">
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-md-2 pull-right" style="margin-top:4px;">
                        <a href="<?php echo e(url('admin/tickets/list')); ?>" class="btn btn-success btn-flat pull-right"><span class="fa fa-chevron-left"> &nbsp;</span>Back to tickets list</a>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lubypay/public_html/sandbox/resources/views/admin/tickets/reply.blade.php ENDPATH**/ ?>