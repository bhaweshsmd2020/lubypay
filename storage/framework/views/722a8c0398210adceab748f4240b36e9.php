...
<?php $__env->startSection('title', 'Add Store Category'); ?>
    ...
    <div class="box">
      <div class="box-body">
        <div class="row">
            <div class="col-md-12">
                <!-- form start -->
                <form action="<?php echo e(url('admin/store/category/store/'. $store_detail->id)); ?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lubypay/public_html/accounts/resources/views/admin/stores/category/create.blade.php ENDPATH**/ ?>