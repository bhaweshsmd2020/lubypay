...
<?php $__env->startSection('title', 'Request Payments'); ?>
<?php $__env->startSection('page_content'); ?>
    ...
    <div class="box box-default">
        <div class="box-body">
            <div class="row">
                <div class="col-md-8">
                    <div class="top-bar-title padding-bottom pull-left">Request Payments</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="box">
        <div class="box-body">
            <form class="form-horizontal" action="<?php echo e(url('admin/request_payments')); ?>" method="GET">
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-2">
                              ...
                              <select class="form-control select2" name="currency" id="currency">
                                  ...
                                  <?php $__currentLoopData = $requestpayments_currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requestpayment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <option value="<?php echo e($requestpayment->currency_id); ?>" <?php echo e(($requestpayment->currency_id == $currency) ? 'selected' : ''); ?>>
                                          <?php echo e($requestpayment->currency->code); ?>
                          ...
                          <div class="col-md-2">
                              ...
                              <select class="form-control select2" name="status" id="status">
                                  ...
                                  <?php $__currentLoopData = $requestpayments_status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requestpayment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <option value="<?php echo e($requestpayment->status); ?>" <?php echo e(($requestpayment->status == $status) ? 'selected' : ''); ?>>
                                      <?php echo e((
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        ...
                                        if (isset($deposit->receiver))
                                        {
                                            $receiver         = $deposit->receiver->first_name . ' ' . $deposit->receiver->last_name;
                                        }
                                        else
                                        {
                                            if (!empty($deposit->email))
                                            {
                                                $receiver         = $deposit->email;
                                            }
                                            elseif (!empty($deposit->phone))
                                            {
                                                $receiver         = $deposit->phone;
                                            }
                                            else
                                            {
                                                $receiver         = '-';
                                        ...
                                        $transaction = DB::table('transactions')->where('uuid', $deposit->uuid)->where('transaction_type_id', Request_To)->first();
                                    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="' . url('admin/users/edit/' . $deposit->user->id) . '"><?php echo e($sender); ?></a></td>
                                        <td><?php echo e(formatNumber($deposit->amount)); ?></td>
                                        <td><?php echo e(formatNumber($transaction->charge_percentage + $transaction->charge_fixed)); ?></td>
                                        <td><?php echo e(formatNumber($transaction->charge_percentage + $transaction->charge_fixed + $deposit->amount)); ?></td>
                                        <td><?php echo e($deposit->currency->code); ?></td>
                                        <td><a href="' . url('admin/users/edit/' . $deposit->receiver->id) . '"><?php echo e($receiver); ?></a></td>
                                        <td>
                                        ...
                                        <td>
                                            <?php if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_request_payment')): ?>
                                                <a href="<?php echo e(url('admin/request_payments/edit/' . $deposit->id)); ?>" class="label label-primary"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/admin/RequestPayment/list.blade.php ENDPATH**/ ?>