        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action='<?php echo e(url("admin/update-password")); ?>' method="POST" class="form-horizontal" id="password_form" >
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lubypay\resources\views/admin/profile/change_password.blade.php ENDPATH**/ ?>