              ...
              <div class="box box-default">
                    <div class="box-header">
                      ...
                      <?php if(Common::has_permission(\Auth::guard('admin')->user()->id, 'add_page')): ?>
                        <div style="float:right;"><a class="btn btn-success" href="<?php echo e(url("admin/settings/page/add")); ?>">Add Page</a></div>
                      <?php endif; ?>
                    </div>
                    <hr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/admin/pages/list.blade.php ENDPATH**/ ?>