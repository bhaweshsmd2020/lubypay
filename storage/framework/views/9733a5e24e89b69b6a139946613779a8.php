                        ...
                        <?php if($documentVerificationStatus): ?>
                            <?php $__currentLoopData = $documentVerificationStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                   ...
                                   <td>
                                        <a href="<?php echo e(url('admin/address-proofs/edit/'.$list->id)); ?>" class="btn btn-xs btn-primary">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/admin/users/addressproof.blade.php ENDPATH**/ ?>