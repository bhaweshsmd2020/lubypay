        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header with-border text-center">
                    <h3 class="box-title">Email Settings <?php if(@$result['status']==1): ?>(<span style="color: green"><i class="fa fa-check" aria-hidden="true"></i>
               Verified</span>) <?php endif; ?> </h3>
                </div>

                <form action="<?php echo e(url('admin/settings/email')); ?>" method="post" class="form-horizontal"
                      id="emai_settings">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/admin/settings/email.blade.php ENDPATH**/ ?>