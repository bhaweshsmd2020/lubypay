...
<?php $__env->startSection('page_content'); ?>
    ...
    <div class="box">
        <div class="box-body">
            <form class="form-horizontal" action="<?php echo e(url('admin/fraud-reports')); ?>" method="GET">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-control select2" name="trans_type" id="trans_type">
                                    <option value="all" <?php echo e(($trans_type =='all') ? 'selected' : ''); ?> >All</option>
                                    <?php if(!empty($transactionTypes)): ?>
                                    <?php $__currentLoopData = $transactionTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($value->id); ?>" <?php echo e(($value->id == $trans_type) ? 'selected' : ''); ?>>
                                        <?php echo e(($value->name == "Withdrawal") ? "Payout" : str_replace('_', ' ', $value->name)); ?>
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $frauds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($userna); ?></td>
                                        <td><?php echo e($report->end_user_id); ?></td>
                                        <td><?php echo e($trans->name); ?></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/admin/fraud/reports.blade.php ENDPATH**/ ?>