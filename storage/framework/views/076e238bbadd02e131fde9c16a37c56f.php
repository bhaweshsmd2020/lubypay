...
<?php $__env->startSection('page_content'); ?>
    ...
    <div class="box">
        <div class="box-body">
            <form class="form-horizontal" action="<?php echo e(url('admin/deposits')); ?>" method="GET">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control select2" name="currency" id="currency">
                                    ...
                                    <?php $__currentLoopData = $d_currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($deposit->currency_id); ?>" <?php echo e(($deposit->currency_id == $currency) ? 'selected' : ''); ?>>
                                            <?php echo e($deposit->currency->code); ?>
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control select2" name="status" id="status">
                                    ...
                                    <?php $__currentLoopData = $d_status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($deposit->status); ?>" <?php echo e(($deposit->status == $status) ? 'selected' : ''); ?>>
                                            <?php echo e(($deposit->status == 'Blocked') ? 'Cancelled' : $deposit->status); ?>
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control select2" name="payment_methods" id="payment_methods">
                                    ...
                                    <?php $__currentLoopData = $d_pm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($deposit->payment_method_id); ?>" <?php echo e(($deposit->payment_method_id == $pm) ? 'selected' : ''); ?>>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_deposit')): ?>
                                                <a href="<?php echo e(url('admin/deposits/edit/' . $deposit->id)); ?>" class="label label-primary"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/admin/deposits/list.blade.php ENDPATH**/ ?>