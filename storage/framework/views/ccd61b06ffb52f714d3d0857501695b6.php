...
<script>
  ...
  // delete script for href
  $(document).on('click', '.notifications-warning', function(e){
    e.preventDefault();
    var url = $(this).attr('href');
    $('#notifications-modal-yes').attr('href', url);
    $('#notifications-warning-modal').modal('show');
  });
  ...
  function update_notification(id, url_to_go, ajax_url){
...
<?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/admin/layouts/partials/body_script.blade.php ENDPATH**/ ?>