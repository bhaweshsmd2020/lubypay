    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                ...
                <form action="<?php echo e(url('admin/admin-users/store')); ?>" class="form-horizontal" id="user_form"
                      method="POST">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lubypay\resources\views/admin/users/adminCreate.blade.php ENDPATH**/ ?>