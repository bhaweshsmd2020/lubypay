                                ...
                                <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if($transaction->transaction_type_id != '2' || ($transaction->transaction_type_id == '2' && $transaction->pay_type != '2')): ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo e(url('admin/users/edit/' . $transaction->user_id)); ?>"><?php echo e($sender); ?></a></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/admin/transactions/index.blade.php ENDPATH**/ ?>