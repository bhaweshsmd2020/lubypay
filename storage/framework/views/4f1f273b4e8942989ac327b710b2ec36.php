...
<div class="row">
    ...
    <div class="col-md-9">
        <div class="box box-info">
            ...
            <form action="<?php echo e(url('admin/settings')); ?>" method="post" class="form-horizontal" enctype="multipart/form-data" id="general_settings_form">
                <?php echo csrf_field(); ?>
                ...
                <!-- box-body -->
        				<div class="box-body">
        					...
        					<div class="form-group">
        					  ...
        					  <div class="col-sm-6">
        					    <input type="text" name="name" class="form-control" value="<?php echo e(@$result['name']); ?>" placeholder="Name">
                  ...
                  <!-- Logo -->
                    ...
                    <div class="col-sm-6">
                      <input type="file" name="photos[logo]" id="logo" class="form-control input-file-field" data-rel="<?php echo e(isset($result['logo']) ? $result['logo'] : ''); ?>" value="<?php echo e(old('photos[logo]')); ?>" placeholder="photos[logo]">

                      <span class="text-danger"><?php echo e($errors->first('photos[logo]')); ?></span>

                      <div class="clearfix"></div>
                      <small class="form-text text-muted"><strong><?php echo e(allowedImageDimension(288,90)); ?></strong></small>

                      <?php if(isset($result['logo'])): ?>
                          <img src='<?php echo e(url('public/images/logos/'. $result['logo'])); ?>' width="288" height="90" id="logo-preview">
                          <span class="remove_img_preview_site_logo"></span>
                      <?php else: ?>
                        <img src='<?php echo e(url('public/uploads/userPic/default-logo.jpg')); ?>' width="288" height="90" id="logo-demo-preview">
                      <?php endif; ?>
                    </div>
                  </div>
        					...
        					<div class="form-group">
        					  ...
        					  <div class="col-sm-6">
        					    <input type="file" name="photos[favicon]" id="favicon" class="form-control input-file-field" data-favicon="<?php echo e(isset($result['favicon']) ? $result['favicon'] : ''); ?>" value="<?php echo e(old('photos[favicon]')); ?>" placeholder="photos[favicon]">
        					  	<span class="text-danger"><?php echo e($errors->first('photos[favicon]')); ?></span>

                      <div class="clearfix"></div>
                      <small class="form-text text-muted"><strong><?php echo e(allowedImageDimension(40,40)); ?></strong></small>

                      <?php if(isset($result['favicon'])): ?>
                        <div class="setting-img">
                          <img src='<?php echo e(url('public/images/logos/'. $result['favicon'])); ?>' width="40" height="40" id="favicon-preview">
                        	<span class="remove_fav_preview"></span>
                        </div>
                      <?php else: ?>

                        <div class="setting-img">
                          <img src='<?php echo e(url('public/uploads/userPic/default-image.png')); ?>' width="40" height="40" id="favicon-demo-preview">
                        </div>
                      <?php endif; ?>
        					  </div>
        					</div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <textarea name="head_code" placeholder="Google Analytics Tracking Code" rows="3" class="form-control"><?php echo e(@$result['head_code']); ?></textarea>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <select class="form-control has_captcha" name="has_captcha" id="has_captcha">
                          <option value='Enabled' <?php echo e($result['has_captcha'] == 'Enabled' ? 'selected':""); ?>>Enabled</option>
                          <option value='Disabled' <?php echo e($result['has_captcha'] == 'Disabled' ? 'selected':""); ?>>Disabled</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <select class="form-control login_via" name="login_via" id="login_via">
                          <option value='email_only' <?php echo e($result['login_via'] == 'email_only' ? 'selected':""); ?>>email only</option>
                          <option value='phone_only' <?php echo e($result['login_via'] == 'phone_only' ? 'selected':""); ?>>phone only</option>
                          <option value='email_or_phone' <?php echo e($result['login_via'] == 'email_or_phone' ? 'selected':""); ?>>email or phone</option>
                      </select>
                    ...
                    <div class="col-sm-6">
                      <select class="form-control default_currency" name="default_currency">
                          <?php $__currentLoopData = $currency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value='<?php echo e($key); ?>' <?php echo e($result['default_currency'] == $key ? 'selected':""); ?>> <?php echo e($value); ?></option>
        					  ...
        					  <div class="col-sm-6">
        					    <select class="form-control default_language" name="default_language">
        					        <?php $__currentLoopData = $language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        					          <option value='<?php echo e($key); ?>' <?php echo e($result['default_language'] == $key ? 'selected':""); ?>> <?php echo e($value); ?></option>
        					        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        					    </select>
        					  </div>
        					</div>
        					<!--<div class="form-group">-->
        					<!--  <label class="col-sm-4 control-label" for="inputEmail3">Virtual Card Fee</label>-->
        					<!--  <div class="col-sm-6">-->
        					<!--    <input type="text" name="virtual_card_fee" class="form-control" value="<?php echo e(@$result['virtual_card_fee']); ?>" placeholder="Virtual Card Fee">-->
        					<!--  	<span class="text-danger"><?php echo e($errors->first('virtual_card_fee')); ?></span>-->
        					<!--  </div>-->
        					<!--</div>-->
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/admin/settings/general.blade.php ENDPATH**/ ?>