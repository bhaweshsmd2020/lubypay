...
<?php $__env->startSection('page_content'); ?>
  ...
  <div class="row">
    <div class="col-md-3">
       <?php echo $__env->make('admin.common.sms_menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <!-- /.col -->
    ...
    <div class="col-md-9">
      <div class="box box-primary">
        ...
        <form action='<?php echo e(url('admin/sms-template/update/'.$tempId)); ?>' method="post" id="sms-template">
          <?php echo csrf_field(); ?>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
                ...
                <textarea name="en[body]" class="form-control editor" id="editor" style="height: 180px"><?php echo e($temp_Data[0]->body); ?></textarea>
          ...
          <div class="box-footer">
            <div class="pull-right">
              ...
              <?php if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_sms_template')): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/admin/sms_templates/index.blade.php ENDPATH**/ ?>