...
<?php $__env->startSection('title', 'Edit Address Verification'); ?>
				...
				<div class="col-md-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="row">
								<form action="<?php echo e(url('admin/address-proofs/update')); ?>" class="form-horizontal" id="deposit_form" method="POST">
										...
										<div class="panel panel-default">
											<div class="panel-body">
	                                            ...
	                                            <div>
	                                            	...
	                                            	<input type="hidden" class="form-control" name="address_file" value="<?php echo e($documentVerification->file->filename); ?>">
	                                                <ul style="list-style-type: none;">
	                                                	<h4 style="text-decoration: underline;">Address Proof</h4>
													    <li> <?php echo e($documentVerification->file->filename); ?>

													    	<a class="text-info pull-right" href="<?php echo e(url('public/uploads/user-documents/address-proof-files').'/'.$documentVerification->file->filename); ?>" target="_blank">
																<i class="fa fa-eye" ></i>
			                                                </a>
															<a class="text-info pull-right" style="margin-right:10px" href="<?php echo e(url('public/uploads/user-documents/address-proof-files').'/'.$documentVerification->file->filename); ?>" download target="_blank">
									...
									<div class="row">
										<div class="col-md-11">
											...
											<div class="col-md-2"><a id="cancel_anchor" class="btn btn-danger pull-left" href="<?php echo e(url('admin/address-proofs')); ?>">Cancel</a></div>
											<div class="col-md-1">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lubynet/public_html/lubypaynew/resources/views/admin/verifications/address_proofs/edit.blade.php ENDPATH**/ ?>