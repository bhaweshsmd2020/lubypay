                    ...
                    <div class="panel-body">
                              ...
                              <div class="col-sm-5">
                                  <label class="checkbox-container">
                                      <input 
                                          ...
                                          value="Yes"
                                          <?php echo e(isset($feeslimit) ? 'checked disabled' : 'checked'); ?>
                              ...
                              <div class="col-sm-4">
                                  <p>
                                      <span class="default_currency_side_text">
                                          <?php echo e(isset($feeslimit) ? 'Default currency is always active' : ''); ?>
                              ...
                              <div class="col-sm-5">
                                  <label class="checkbox-container">
                                      <input 
                                          ...
                                          name="has_transaction" 
                                          value="Yes"
                                          <?php echo e(isset($feeslimit->has_transaction) && $feeslimit->has_transaction == 'Yes' ? 'checked' : ''); ?>
                      ...
                      <?php if($trans_type == 1): ?>
                        <div class="form-group">
                          ...
                          <div class="col-sm-5">
                            <input class="form-control min_balance" name="min_balance" type="text" value="<?php echo e(isset($feeslimit->min_balance) ? number_format((float)$feeslimit->min_balance, $preference['decimal_format_amount'], '.', '') : number_format((float)0.00000000, $preference['decimal_format_amount'], '.', '')); ?>" id="min_balance" oninput="restrictNumberToPrefdecimal(this)">
                        ...
                        <div class="charge-range border p-3">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-5">
                              <input class="form-control max_limit" name="max_limit" type="text" value="<?php echo e(isset($feeslimit->max_limit) ? number_format((float)$feeslimit->max_limit, $preference['decimal_format_amount'], '.', '') : ''); ?>" id="max_limit" oninput="restrictNumberToPrefdecimal(this)">
                              <small class="form-text text-muted"><strong><?php echo e(allowedDecimalPlaceMessage($preference['decimal_format_amount'])); ?></strong></small>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-5">
                              <input class="form-control charge_fixed" name="charge_fixed" type="text" value="<?php echo e(isset($feeslimit->charge_fixed) ? number_format((float)$feeslimit->charge_fixed, $preference['decimal_format_amount'], '.', '') : number_format((float)0.00000000, $preference['decimal_format_amount'], '.', '')); ?>" id="charge_fixed" oninput="restrictNumberToPrefdecimal(this)">
                              <small class="form-text text-muted"><strong><?php echo e(allowedDecimalPlaceMessage($preference['decimal_format_amount'])); ?></strong></small>
                        ...
                        <div class="charge-range border p-3">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-5">
                              <input class="form-control second_max_limit" name="second_max_limit" type="text" value="<?php echo e(isset($feeslimit->second_max_limit) ? number_format((float)$feeslimit->second_max_limit, $preference['decimal_format_amount'], '.', '') : ''); ?>" id="second_max_limit" oninput="restrictNumberToPrefdecimal(this)">
                              <small class="form-text text-muted"><strong><?php echo e(allowedDecimalPlaceMessage($preference['decimal_format_amount'])); ?></strong></small>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-5">
                            <input class="form-control recom_amt" name="recom_amt" type="text" value="<?php echo e($feeslimit->recom_amt??''); ?>" id="recom_amt" oninput="restrictNumberToPrefdecimal(this)">
                            <small class="form-text text-muted"><strong><?php echo e(allowedDecimalPlaceMessage($preference['decimal_format_amount'])); ?></strong></small>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-5">
                            <textarea class="form-control description" name="description" id="description"><?php echo e($feeslimit->description??''); ?></textarea>
                      ...
                      <?php else: ?>
                        <div class="form-group">
                          ...
                          <div class="col-sm-5">
                            <input class="form-control card_limit" name="card_limit" type="text" value="<?php echo e($feeslimit->card_limit??'1'); ?>" id="card_limit"  oninput="restrictNumberToPrefdecimal(this)">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lubypay\resources\views/admin/feeslimits/deposit_limit_single.blade.php ENDPATH**/ ?>