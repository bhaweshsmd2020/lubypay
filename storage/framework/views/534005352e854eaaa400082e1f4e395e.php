...
<?php $__env->startSection('title', 'Reloads'); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_deposit')): ?>
                                                <a href="<?php echo e(url('admin/card/reload/details/' . $transaction->id)); ?>" class="label label-primary"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;
                                            <?php endif; ?>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/admin/cards/reloads.blade.php ENDPATH**/ ?>