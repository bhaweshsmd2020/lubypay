                ...
                <tbody>
                    <tr>
                        <td class="column" style="padding: 0; text-align: left; vertical-align: top; color: #60666d; font-size: 14px; line-height: 21px; font-family: sans-serif; width: 600px;">
                            ...
                            <div style="margin-left: 20px; margin-right: 20px;">
                                <p class="size-14" style="margin-top: 0; margin-bottom: 0; font-size: 14px; line-height: 21px;">Saludos,<br /><strong>LubyPay</strong></p>
                            </div>
                            <div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="padding:20px 40px 0px;" align="center">
                                                <h1 style="text-align: center;font-family: 'Open sans', Arial, sans-serif; font-size: 28px;">CONECTÉMONOS</h1>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
...
</html><?php /**PATH /home/lubypay/public_html/develop/resources/views/emails/sendesmail.blade.php ENDPATH**/ ?>