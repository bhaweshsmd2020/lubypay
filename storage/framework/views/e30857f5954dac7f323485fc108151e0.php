...
<?php $__env->startSection('title', 'Merchant Groups'); ?>
    ...
    <div class="col-md-9">
      <div class="box box_info">
            <div class="box-header">
              ...
              <?php if(Common::has_permission(\Auth::guard('admin')->user()->id, 'add_merchant_group')): ?>
                <div style="float:right;"><a class="btn btn-success" href="<?php echo e(url('admin/settings/add-merchant-group')); ?>">Add Group</a></div>
              <?php endif; ?>
            </div>
            <hr>
            <!-- /.box-header -->
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/admin/merchant_group/list.blade.php ENDPATH**/ ?>