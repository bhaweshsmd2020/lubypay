                ...
                <form action="<?php echo e(url('admin/settings/key_informations')); ?>" method="post" class="form-horizontal" id="api-credentials" >
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="text" name="main_url" class="form-control" value="<?php echo e($giftcard['main_url'] or ''); ?>" placeholder="Gift Card Main Ur">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="text" name="client_id" class="form-control" value="<?php echo e($giftcard['client_id'] or ''); ?>" placeholder="Gift Card Client Id">
                    ...
                    <!--client_secret-->
                       <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="text" name="client_secret" class="form-control" value="<?php echo e($giftcard['client_secret'] or ''); ?>" placeholder="Gift Card Client Secret Key">
            ...
            <div class="box box-info">
                ...
                <form action="<?php echo e(url('admin/settings/persona_informations')); ?>" method="post" class="form-horizontal" id="apis-credentials" >
                    ...
                    <div class="box-body">
                          ...
                          <div class="col-sm-6">
                           <input type="text" name="persona_templete" class="form-control" value="<?php echo e($persona['persona_templete'] or ''); ?>" placeholder="Persona Templete">
                          ...
                          <div class="col-sm-6">
                           <input type="text" name="persona_api_key" class="form-control" value="<?php echo e($persona['persona_api_key'] or ''); ?>" placeholder="Persona Api key">
                         ...
                         <div class="form-group">
                          ...
                          <div class="col-sm-6">
                              <select name="mode" class="form-control" value="<?php echo e($persona['mode'] or ''); ?>" placeholder="mode">
                ...
                <form action="<?php echo e(url('admin/settings/ding_informations')); ?>" method="post" class="form-horizontal" id="dingapis-credentials" >
                    ...
                    <div class="box-body">
                          ...
                          <div class="col-sm-6">
                           <input type="text" name="ding_main_url" class="form-control" value="<?php echo e($ding['ding_main_url'] or ''); ?>" placeholder="Ding main url">
                          ...
                          <div class="col-sm-6">
                           <input type="text" name="ding_api_key" class="form-control" value="<?php echo e($ding['ding_api_key'] or ''); ?>" placeholder="Ding Api key">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/admin/settings/keys.blade.php ENDPATH**/ ?>