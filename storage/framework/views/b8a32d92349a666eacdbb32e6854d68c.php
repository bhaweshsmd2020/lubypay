                    ...
                    <div class="box-body">
                        ...
                        <!-- <div class="row">
							<div class="col-md-11">
								...
								<div class="col-md-2"><a class="btn btn-danger pull-left btn-flat" href="<?php echo e(url('admin/admin_users')); ?>" id="users_cancel">Cancel</a></div>
								<div class="col-md-1">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <a class="btn btn-danger pull-right btn-flat" href="<?php echo e(url('admin/admin_users')); ?>" id="users_cancel">Cancel</a>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <!-- <div class="box-footer">
                            <a class="btn btn-danger btn-flat pull-left" href="<?php echo e(url('admin/admin_users')); ?>"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lubypay/public_html/accounts/resources/views/admin/users/adminEdit.blade.php ENDPATH**/ ?>