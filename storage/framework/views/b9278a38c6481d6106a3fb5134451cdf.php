...
<ul class="sidebar-menu">
    ...
    <li <?= $menu == 'mpos' ? ' class="active treeview"' : 'treeview'?> >
        <a href="#">
            <i class="fa fa-user-secret"></i><span>mPOS</span>
            <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
        </a>
        <ul class="treeview-menu">
            <?php if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_merchant')): ?>
    ...
    <li <?= $menu == 'cards' ? ' class="active treeview"' : 'treeview'?> >
        <a href="#">
            <i class="fa fa-credit-card-alt"></i><span>Cards</span>
            <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
        </a>
        <ul class="treeview-menu">
            <?php if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_merchant')): ?>
            ...
            <!--            <i class="fa fa-user-o"></i><span>Card Requests</span>-->
            <!--        </a>-->
            <!--    </li>-->
            <!--<?php endif; ?>-->
            
            <!--<?php if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_merchant')): ?>-->
            <!--    <li <?= isset($sub_menu) && $sub_menu == 'allcards' ? ' class="active"' : ''?> >-->
            <!--        <a href="<?php echo e(url('admin/all/cards')); ?>">-->
            <!--            <i class="fa fa-credit-card"></i><span>Cards Created</span>-->
            <!--        </a>-->
            <!--    </li>-->
            <!--<?php endif; ?>-->
    ...
    <?php if(Common::has_permission(\Auth::guard('admin')->user()->id, 'fraud_section_view')): ?>
    ...
    <?php endif; ?>
</ul><?php /**PATH /home/ticktappay/public_html/paymoney/resources/views/admin/layouts/partials/sidebar_menu.blade.php ENDPATH**/ ?>