    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                    ...
                    <form action="<?php echo e(url('admin/labels/store')); ?>" class="form-horizontal" method="POST" id="user_form">
                        ...
                        <input type="hidden" value="<?php echo e(csrf_token()); ?>" name="_token" id="token">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="french">
                                        French
                                    </label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="french" name="french">
                                    </div>
                                </div>
                                
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="haiti">
                                        Haiti
                                    </label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="haiti" name="haiti">
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lubypay/public_html/accounts/resources/views/admin/labels/create.blade.php ENDPATH**/ ?>