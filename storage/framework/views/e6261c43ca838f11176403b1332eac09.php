...
<?php $__env->startSection('title', 'Merchants KYC'); ?>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($user->defaultCountry); ?></td>
                                        <td>
                                            <?php 
                                                if(!empty($kycstatus)){
                                                    echo $kycstatus; 
                                        ...
                                        <td>
                                            <?php if($kyc_method == 'Manual KYC'): ?>
                                                <?php if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_mpos_kyc')): ?>
                                            ...
                                            <?php elseif($kyc_method == 'Auto KYC'): ?>
                                                ...
                                                <?php if(Common::has_permission(\Auth::guard('admin')->user()->id, 'delete_mpos_kyc')): ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lubypay/public_html/accounts/resources/views/admin/users/merchantskyc.blade.php ENDPATH**/ ?>