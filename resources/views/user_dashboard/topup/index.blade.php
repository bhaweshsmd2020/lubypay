            ...
            <div class="col-md-6 border py-3" style="border-radius:10px; background: #fff;">
                <div class="text-center">
                    ...
                    <div class="content" style="min-height: auto;">
                        ...
                        <p>Delivery amount: <span id="destinationcurrencycode"></span> <span id="fx_rate"></span></p>
                    </div>
...
$("#getvalue").click(function(){
  	jQuery.ajax({
		...
		success: function (result) {
            ...
            jQuery("#fx_rate").html(result.value.fxRate);
            jQuery("#fx_rate1").val(result.value.fxRate);
