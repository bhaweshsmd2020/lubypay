	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-7 col-xs-12 mb20 marginTopPlus">
				...
				<form action="{{url('attributes/updatevalue')}}"  method="post" enctype="multipart/form-data" accept-charset="utf-8" id="product_add_form">
						...
						<div class="wap-wed mt20 mb20">
						    ...
						    <div class="form-group">
								...
								<select class="form-control select2" id="attribute_id" name="attribute_id">
								    ...
								    <option value="{{$lists->id}}" <?php if($lists->id == $details['attribute_id']){ echo 'selected'; } ?>>{{$lists->name}}</option>
								    <?php }?>
								</select>
							...
							<div class="form-group">
								...
								<input value="{{$details['value']}}" class="form-control" name="value" id="value"  type="text">
								@if($errors->has('value'))
								<span class="help-block">
