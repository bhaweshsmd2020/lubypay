                        ...
                        <div class="table-responsive">
                            @if($listvalues->count() > 0)
                                <table class="table recent_activity">
                                    ...
                                    <tbody>
                                        @php $j=1 @endphp
                                    @foreach($listvalues as $results)
                                        <tr>
                                            <td>{{ $j }}</td>
                                            <td>{{ ($results->attribute) ? $results->attribute->name : '-'}} </td>
                                            <td>{{ $results->value}} </td>
                                            
                                            <td>
                                                
                                                <a href="{{url('attributes/editvalue/'.$results->id)}}" class="btn btn-sm btn-info"><i class="fa fa-pencil"></i></a>
                                            </td>
                                        </tr>
                                         @php $j++ @endphp
                                    @endforeach
