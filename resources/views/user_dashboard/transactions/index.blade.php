                            ...
                            <form action="" method="get">
                                ...
                                <div class="">
                                    <div class="filter_panel">
                                        ...
                                        @endphp
                                        <p style="margin-top: 15px; margin-bottom: 15px; margin-right: 10px;">@lang('message.dashboard.transaction.total-sales'): 
                                            <strong>{{ $wallets[0]->currency->code }} {{ formatNumber($totalSales) }}</strong>
                                        </p>
                                        <p style="margin-top: 15px; margin-bottom: 15px; margin-right: 10px;">@lang('message.dashboard.transaction.total-due'): 
                                            <strong>{{ $wallets[0]->currency->code }} {{ formatNumber($totalDue) }}</strong>
                                        </p>
                                        @endif
                                    </div>
                                    <div class="filter_panel">
                                    ...
                                    <div class="">
                                        <button type="submit" class="btn btn-cust" style="    padding: 5px 12px;">@lang('message.dashboard.button.filter')</button>
                                    </div>
                                                        ...
                                                        <td class="text-left">
                                                            @if($transaction->transaction_type_id)
                                                                @if($transaction->transaction_type_id==Request_From)
                                                                    ...
                                                                    <p>{{ $transaction->end_user->first_name??'' }}</p>
...
<!--</td>-->
                                                ...
                                                <!-- Phone -->
                                                <td class="text-left"><p>{{ $transaction->phone }} </p></td>
                                            ...
                                            <tr id="collapseRow{{$key}}" class="collapse">
                                                <td colspan="8" class="">
                                                    <div class="row activity-details" id="loader_{{$transaction->id}}" style="min-height: 200px">
                                    ...
                                    @else
                                        <tr>
                                            ...
                                            <td colspan="8"> <img src="{{url('public/images/nodata.png')}}" style="    margin: 35px 0px;"></td>
                                        </tr>
                                    @endif
                                    </tbody>
                                </table>
