                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control wallet" name="currency_id" id="currencies">
                                    @foreach ($storeCurrencyData as $aCurrency)
                                        <option value="{{ $aCurrency['id'] }}"{{ isset($data['currency_id']) && $data['currency_id'] == $aCurrency['id'] ? 'selected="selected"' : '' }}>{{ $aCurrency['code'] }}</option>
                                    @endforeach
                                </select>
                            </div>
								...
								<label>Store Location</label>
								 <select class="form-control" name="country" id="country">
                                    @foreach ($countries as $country)
                                        <option value="{{ $country->id }}" {{ $data['country'] == $country->id ? 'selected="selected"' : '' }}>{{ $country->name }}</option>
                                    @endforeach
                                </select>
