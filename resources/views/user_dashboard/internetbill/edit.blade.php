    ...
    <div class="col-md-9">
      ...
      <div class="box box-info">
        <div class="box-header with-border text-center">
          <h3 class="box-title">Edit Internet Bill</h3>
        </div>

        <!-- form start -->
        <form method="POST" action="{{ url('admin/utility/edit-internet-bill') }}" class="form-horizontal" id="pay_internet_form">
          {{ csrf_field() }}
          ...
          <div class="box-footer">
            <a class="btn btn-danger" href="{{ url('admin/utility/internet') }}">Cancel</a>
