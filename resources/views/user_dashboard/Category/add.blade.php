		...
		<div class="row">
		   @include('user_dashboard.layouts.common.tab')
			<div class="col-md-7 col-xs-12 mb20 marginTopPlus">
				...
				<form action="{{url('categories/store')}}"  method="post" enctype="multipart/form-data" accept-charset="utf-8" id="product_add_form">
					...
					<div class="card">
						...
						<div class="wap-wed mt20 mb20">
						    <div class="form-group">
								...
								<input value="{{Input::old('order')}}" class="form-control" name="order" id="order"  type="text">
								@if($errors->has('order'))
