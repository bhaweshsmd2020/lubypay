...
@section('page_content') 
    ...
    <div class="col-md-9">
      ...
      <div class="box box-info">
        ...
        <!-- form start -->
        <form method="POST" action="{{ url('admin/utility/pay-electricity-bill') }}" class="form-horizontal" id="pay_electricity_form">
          {{ csrf_field() }}
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label" for="operator_id">Operator</label>
              <div class="col-sm-6">
               <select name="operator_id" class="form-control select2" placeholder="Select Operator" id="operator_id">
                    <option value="">Select Operator</option>
                    @foreach($operators as $operator)
                    <option value="{{$operator->id}}">{{$operator->type}}</option>
                    @endforeach
                </select>
