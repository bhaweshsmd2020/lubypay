                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="chart-list float-left">
                                <ul>
                                    ...
                                    <li class="active"><a href="{{url('/profile/personal-photo')}}">@lang('message.personal-photo.title')
                                        </a>
                                    </li>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <!-- form -->
                                    <form action="{{ url('profile/personal-photo-update') }}" method="POST" class="form-horizontal" id="personal_photo" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-5">
                                                <label for="address_file">@lang('message.personal-photo.upload-photo-proof')(upto 10MB)</label>
                                        ...
                                        @if (!empty($documentVerification->file))
                                            <h5>
                                                <a class="text-info" href="{{ url('public/uploads/user-documents/photo-proof-files').'/'.$documentVerification->file->filename }}"><i class="fa fa-download"></i>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-5">
                                                <button type="submit" class="btn btn-cust col-12" id="personal_photo_submit">
                                                    <i class="spinner fa fa-spinner fa-spin" style="display: none;"></i> <span id="personal_photo_submit_text">@lang('message.dashboard.button.submit')</span>
                                                </button>
                                            </div>
                                        </div>
                                    </form>
