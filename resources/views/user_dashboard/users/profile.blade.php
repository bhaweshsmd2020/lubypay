                                                    ...
                                                    <form method="post" action="{{url('prifile/update_password')}}" id="reset_password">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <button type="button" class="btn btn-cust closes" data-dismiss="modal">@lang('message.form.close')</button>
                                                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <hr>
                                        <form method="post" action="{{url('prifile/update')}}" id="profile_update_form">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label for="postal_code">@lang('message.dashboard.setting.postal_code')</label>
                                                    <input type="text" class="form-control" name="postal_code" id="postal_code" value="{{ $user->user_detail->zip_code }}">
                                            ...
                                            <!--<div class="row">-->
                                            <!--    <div class="form-group col-md-6">-->
                                            <!--        <label for="dob">@lang('message.dashboard.setting.dob')</label>-->
                                            ...
                                            <!--<div class="row">-->
                                            <!--    <div class="form-group col-md-6">-->
                                            <!--        <label for="nationality">@lang('message.dashboard.setting.nationality')</label>-->
                                            <!--        <input type="text" class="form-control" name="nationality" id="nationality" value="{{ $user->nationality }}">-->
                                            ...
                                            <!--    </div>-->
                                            <!--    <div class="form-group col-md-6">-->
                                            <!--        <label for="job_title">@lang('message.dashboard.setting.job_title')</label>-->
                                            <!--        <input type="text" class="form-control" name="job_title" id="job_title" value="{{ $user->job_title }}">-->
                                            ...
                                            <!--<div class="row">-->
                                            <!--    <div class="form-group col-md-6">-->
                                            <!--        <label for="id_type">@lang('message.dashboard.setting.id_type')</label>-->
                                            <!--        <select name="id_type" id="id_type" class="form-control">-->
                                            <!--            <option value="">@lang('message.personal-id.select-type')</option>-->
                                            <!--            <option value="driving_license"-->
                                            <!--            {{ !empty($user->id_type) && $user->id_type == 'driving_license' ? 'selected' : '' }}>-->
                                            <!--                @lang('message.personal-id.driving-license')-->
                                            <!--            </option>-->
                                            <!--            <option value="passport" {{ !empty($user->id_type) && $user->id_type == 'passport' ? 'selected' : '' }}>@lang('message.personal-id.passport')</option>-->
                                            <!--            <option value="national_id" {{ !empty($user->id_type) && $user->id_type == 'national_id' ? 'selected' : '' }}>@lang('message.personal-id.national-id')</option>-->
                                            <!--        </select>-->
                                            ...
                                            <!--    </div>-->
                                            <!--    <div class="form-group col-md-6">-->
                                            <!--        <label for="id_number">@lang('message.dashboard.setting.id_number')</label>-->
                                            <!--        <input type="number" name="id_number" class="form-control" value="{{ !empty($user->id_number) ? $user->id_number : '' }}">-->
