                    ...
                    <div class="card-footer" style="margin-left: 0 auto">
					    <div style="float: left;">
                            <a href="#" class="deposit-confirm-back-link">
                                <button class="btn btn-cust deposit-confirm-back-btn"><i class="fa fa-angle-left"></i>&nbsp;&nbsp;@lang('message.dashboard.button.back')</button>
                            </a>
						</div>
					    <div style="float: right;">
                            <form action="{{url('deposit/store')}}" style="display: block;" method="POST" accept-charset="UTF-8" id="deposit_form" novalidate="novalidate" enctype="multipart/form-data">
								...
								<button type="submit" class="btn btn-cust" id="deposit-money-confirm">
		                  			<i class="spinner fa fa-spinner fa-spin" style="display: none;"></i> <span id="deposit-money-confirm-text">@lang('message.dashboard.button.confirm')&nbsp; <i class="fa fa-angle-right"></i></span>
		                  		</button>
							</form>
						</div>
                    </div>
