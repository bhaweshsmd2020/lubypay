                        ...
                        <form action="{{ url('deposit/bank-payment') }}" style="display: block;" method="POST" accept-charset="UTF-8" id="bank_deposit_form" enctype="multipart/form-data">
                            ...
                            <div class="wap-wed mt20 mb20">
                                ...
                                <div id="attached_file">
                                 ...
                                 <div id="ref_num">
                                    <div class="form-group">
                                        <label for="bank" class="h6"><strong>Reference Number</strong></label>
                                        <input type="text" name="ref_num" class="form-control ref_num " placeholder="enter reference number..." data-rel="">
                                    </div>
                                </div>
                                  <center><div class="row details">
                                   <div class="alert alert-warning" style="width: -webkit-fill-available;background-color: #800000!important;margin-left: 25%;margin-right: 33%;">
                                     <strong>Status :  </strong><b id="status_id"></b><br>
                                     <strong>Ref Num : </strong><b id="ref_id"></b><br>
                                     <strong>Amount : </strong> <b id="amt_id"></b>
                                    </div> 
                                  </div>
                                  </center> 
                                <!--bank logo-->
                            ...
                            <div class="card-footer" style="margin-left: 0 auto;">
                                ...
                                <div style="float: right;" id="ref">
                                    <a class="btn btn-cust" id="check-ref">
                                        <i class="spinner fa fa-spinner fa-spin" style="display: none;"></i> <span id="deposit-money-text">Verify Ref Number&nbsp; <i class="fa fa-angle-right"></i></span>
                                    </a>
                                </div>
                                
                                <div style="float: right;" id="deposit">
...
<script>
    $('#check-ref').click(function()
    {
        ...
        }else
        {
           $.ajax({
           type:"GET",
           url: SITE_URL+"/deposit/bank-payment/check-ref?ref_num="+ref_num,
    ...
    function getBanks()
    {
        ...
        if (bank)
        {
            ...
            .done(function(response)
            {
                ...
                {
                    if(response.bank.bank_name == 'Maldives Islamic Bank')
                    {
                        $('#ref_num').show();
                         $('#ref').show();
                        $('#deposit').hide();
    ...
    $('#bank_deposit_form').validate({
        ...
        messages: {
          ...
          ref_num: {
            message: "{{__("Reference number is required!")}}"
          },
        },
