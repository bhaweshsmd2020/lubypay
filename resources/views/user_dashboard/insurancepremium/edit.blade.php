...
@section('title', 'Pay Insurance Premium')
    ...
    <div class="col-md-9">
      ...
      <div class="box box-info">
        <div class="box-header with-border text-center">
          <h3 class="box-title">Edit Insurance Premium</h3>
        </div>

        <!-- form start -->
        <form method="POST" action="{{ url('admin/utility/edit-insurance-bill') }}" class="form-horizontal" id="pay_insurance_form">
          {{ csrf_field() }}
          ...
          <div class="box-footer">
            <a class="btn btn-danger" href="{{ url('admin/utility/insurance') }}">Cancel</a>
