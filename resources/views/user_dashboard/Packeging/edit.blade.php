	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-7 col-xs-12 mb20 marginTopPlus">
				...
				<form action="{{url('packeging/update')}}"  method="post" enctype="multipart/form-data" accept-charset="utf-8" id="product_add_form">
						...
						<div class="wap-wed mt20 mb20">
						   ...
						   <input value="{{$details['id']}}" class="form-control" name="id" id="id"  type="hidden">
							...
							<select class="form-control" name="shipping" id="shipping">
							    ...
							    <option value="{{$lists->id}}" {{($details['shipping'] ==$lists->id) ? 'selected' :''}}>{{$lists->name}}</option>
							    <?php }?>
							</select>
							...
							<div class="form-group">
								...
								<div class="row">
								    <div class="col-md-2">
								        	<input value="{{$details['length']}}" class="form-control" name="length" id="length" placeholder="L"  type="text">
								    ...
								    <div class="col-md-2">
								        	<input value="{{$details['width']}}" class="form-control" name="width" id="width" placeholder="W"  type="text">
            								@if($errors->has('width'))
            								<span class="help-block">
								    ...
								    <div class="col-md-2">
								        	<input value="{{$details['height']}}" class="form-control" name="height" id="height" placeholder="H" type="text">
								    ...
								    <div class="col-md-4">
								        	<select class="form-control" name="dimension_unit" id="dimension_unit">
								        	    <option value="cm" {{($details['dimension_unit'] =='cm') ? 'selected' :''}}>CM</option>
								        	    <option value="m" {{($details['dimension_unit'] =='m') ? 'selected' :''}}>Meter</option>
								        	</select>
							...
							<div class="form-group">
								...
								<div class="row">
								    <div class="col-md-6">
								        	<input value="{{$details['weight']}}" class="form-control" name="weight" id="weight" placeholder="Weight"  type="text">
								    ...
								    <div class="col-md-4">
								        	<select class="form-control" name="weight_unit" id="weight_unit">
								        	    <option value="kg" {{($details['weight_unit'] =='kg') ? 'selected' :''}}>KG</option>
								        	</select>
                             ...
                             <div class="form-group">
							   ...
							   <input value="{{$details['name']}}" class="form-control" name="name" id="name" placeholder=""  type="text">
