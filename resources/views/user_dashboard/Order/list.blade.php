            ...
            <div class="row">
                <div class="col-md-12 col-xs-12 mb20 marginTopPlus">
                    ...
                    <div class="right mb10" style="height: 15px;">
                        <!--<a href="{{url('/merchant/add')}}" class="btn btn-cust ticket-btn" style="padding: 2px 10px;"><i class="fa fa-user"></i>&nbsp;-->
                    ...
                    <div class="card">
                                    ...
                                    @foreach($list as $result)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{url('orders/detail/'.$result->id)}}" class="btn btn-secondary btn-sm"><i class="fa fa-eye"></i></a>
                                                <!--<a href="{{url('orders/edit/'.$result->id)}}" class="btn btn-sm btn-info"><i class="fa fa-pencil"></i></a>-->
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                        ...
                        @else
                            ...
                            <h5 style="padding: 15px 10px; text-align: center;"> <img src="{{url('public/images/nodata.png')}}" style="    margin: 35px 0px;"></h5>
                        @endif
