	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-7 col-xs-12 mb20 marginTopPlus">
				...
				<form action="{{url('product/store')}}"  method="post" enctype="multipart/form-data" accept-charset="utf-8" id="product_add_form">
					...
					<div class="card">
						...
						<div class="wap-wed mt20 mb20">
						    ...
						    <div class="form-group">
								...
								<input value="{{Input::old('product_id')}}" class="form-control" name="product_id" id="product_id"  type="text">
							...
							<div class="form-group">
							    ...
							    <select name="category_id" id="category_id" class="form-control" required>
							        ...
							        <option value="{{$category->id}}"  <?=($category->id ==Input::old('category_id')) ? 'selected' : '' ?> >{{$category->name}}</option>
							        <?php }?>
							    </select>
						   ...
						   <?php foreach($attributes as $attr){?>
						    <div class="form-group">
						        <?php $Attrvalues = DB::table('attribute_values')->where('attribute_id',$attr->id)->where('active',1)->get();
								    ...
								    if(isset($Attrvalues) && count($Attrvalues)){?>
								...
								<select name="attributes_{{$attr->id}}[]" id="attribute_values" class="form-control" multiple>
							        ...
							        ?>
							        <option value="{{$vallues->id}}" >{{$vallues->value}}</option>
							        <?php }}?>
							    </select>
							...
							<div class="form-group">
								...
								<input value="{{Input::old('product_name')}}" class="form-control" name="product_name" id="product_name"  type="text">
							...
							<div class="form-group">
								...
								<input value="{{Input::old('price')}}" class="form-control" name="price" id="price"  placeholder="0.00" type="number">
								@if($errors->has('price'))
								<span class="help-block">
                            ...
                            <div class="form-group">
								...
								<input value="{{Input::old('quantity')}}" class="form-control" name="quantity" id="quantity"  placeholder="10" type="number">
							...
							<!--	<input value="{{Input::old('weight')}}" class="form-control" name="weight" id="weight"  placeholder="10" type="number">-->
							...
							<!--	<input value="{{Input::old('height')}}" class="form-control" name="height" id="height"  placeholder="10" type="number">-->
							...
							<!--	<input value="{{Input::old('length')}}" class="form-control" name="length" id="length"  placeholder="10" type="number">-->
							...
							<!--	<input value="{{Input::old('width')}}" class="form-control" name="width" id="width"  placeholder="10" type="number">-->
							<!--	@if($errors->has('width'))-->
							<!--	<span class="help-block">-->
