                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table id="transactionTable" class="table align-middle mb-0 custom-table">
                            ...
                            <tbody>
                                @foreach($wallets as $wallet)
                                    <tr>
                                        ...
                                        <td>{{ $wallet->is_default ? 'Yes' : 'No' }}</td>
                            ...
                            {{-- <tbody>
                                <tr>
                                    <td class="withdraw" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                        <i class="bi bi-arrow-down-left-circle" style="vertical-align: middle; margin-right: 8px;"></i> Withdraw
                                    </td>
                                    <td>30 Oct 2022</td>
                                    <td>€3200.00</td>
                                ...
                                <tr>
                                    <td class="deposit">
                                        <i class="bi bi-arrow-up-right-circle" style="vertical-align: middle; margin-right: 8px;"></i> Deposit
                                    </td>
                                    <td>20 Mar 2022</td>
                                    <td>€2200.00</td>
                                    <td class="status-pending">Pending</td>
