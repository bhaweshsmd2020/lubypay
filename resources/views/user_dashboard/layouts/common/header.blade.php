...
<ul class="sidebar-menu">
    ...
    <li class="{{ isset($menu) && $menu == 'wallet' ? 'active' : '' }}">
        <a href="{{ route('wallet') }}"> <i class="bi bi-wallet-fill" style="margin-right: 18px;"></i> Wallet </a>
    </li>

     <li class=" {{ isset($menu) && $menu == 'comissions' ? 'active' : ''}}">
        <a href="{{ route('comissions') }}"> <i class="bi bi-file-earmark-text" style="margin-right: 18px;"></i>  Commissions </a>
    </li>
