  ...
  <div class="container">
      <div class="row">
          <div class="col-md-12">
            ...
            ?>
            <p class="copyright">@lang('message.footer.copyright') &copy; {{date('Y')}} &nbsp;&nbsp; {{ $company_name }} |<!-- @lang('message.footer.copyright-text')-->
             Powered By <a href="https://www.smdwebtech.com" target="_blank" style="color:#3c8dbc">SMD Webtech</a></p>
          </div>
      </div>
  </div>
</footer>
