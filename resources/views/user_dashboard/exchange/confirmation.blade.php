				...
				<div class="card">
					...
					<div class="wap-wed mt20 mb20">
						<p class="mb20">@lang('message.dashboard.exchange.confirm.exchanging') <strong>{{ $fromCurrency->code }}</strong>
							 <strong>{{ isset($transInfo['defaultAmnt']) ? formatNumber($transInfo['defaultAmnt']) : 0.00 }}</strong>
							@lang('message.dashboard.exchange.confirm.to') <strong>{{ isset($transInfo['finalAmount']) ? formatNumber($transInfo['finalAmount']) : 0.00 }} {{ $transInfo['currCode'] }}</strong><br/>@lang('message.dashboard.exchange.confirm.exchange-rate'):  &nbsp;<strong>1 {{$fromCurrency->code}} </strong>= <strong>
