<div class="box box-primary">
  ...
  <div class="box-body no-padding" style="display: block;">
    <ul class="nav nav-pills nav-stacked">
      ...
      <li {{ isset($list_menu) &&  $list_menu == 'braintree' ? 'class=active' : ''}} >
        <a data-spinner="true" href='{{ url('admin/settings/payment-methods/braintree/'.$currency->id) }}'>Braintree</a>
      </li>
      
      <li {{ isset($list_menu) &&  $list_menu == 'plaid' ? 'class=active' : ''}} >
        <a data-spinner="true" href='{{ url('admin/settings/payment-methods/plaid/'.$currency->id) }}'>ACH</a>
      </li>
