    ...
    <div class="panel-body">
        ...
        <ul class="nav navbar-pills nav-tabs nav-stacked no-margin" role="tablist">
            ...
            @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_merchant_group'))
                ...
                <!--    <a href="{{ url('admin/settings/merchant-document') }}">-->
                <!--        <i class="fa fa-user-secret"></i>-->
                <!--        <span>-->
                <!--            Merchant Document-->
                <!--        </span>-->
            ...
            @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_utility_setting'))
                <li <?= $sub_sub_menu == 'all_utility' ? ' class="treeview active"' : 'treeview'?>>
                    <a data-group="preference" href="{{ url('admin/settings/utility') }}">
                        <i class="fa fa-cogs">
                        </i>
                        <span>
                            Utility Setting
            ...
            @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_revenue_sharing'))
            <li <?= $sub_sub_menu == 'revenues' ? ' class="treeview active"' : 'treeview'?>>
                <a data-group="brands" href="{{ url('admin/settings/revenues') }}">
