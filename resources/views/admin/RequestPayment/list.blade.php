                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                @foreach($requests as $index=>$deposit)
                                    <?php
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="' . url('admin/users/edit/' . $deposit->user->id) . '">{{$sender}}</a></td>
                                        <td>{{formatNumber($deposit->amount)}}</td>
                                        <td>{{formatNumber($transaction->charge_percentage + $transaction->charge_fixed)}}</td>
                                        <td>{{formatNumber($transaction->charge_percentage + $transaction->charge_fixed + $deposit->amount)}}</td>
                                        <td>{{$deposit->currency->code}}</td>
                                        <td><a href="' . url('admin/users/edit/' . $deposit->receiver->id) . '">{{$receiver}}</a></td>
                                        <td>
                                        ...
                                        <td>
                                            @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_request_payment'))
                                                <a href="{{ url('admin/request_payments/edit/' . $deposit->id) }}" class="label label-primary"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
