			...
			<div class="box box-info">
					...
					<div class="box-body">
						...
						@elseif($list_menu == 'braintree')
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->public_key : '' }}" id="braintree_public_key">

									@if ($errors->has('braintree[public_key]'))
									<span class="help-block">
										<strong>{{ $errors->first('braintree[public_key]') }}</strong>
									</span>
									@endif
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->private_key : '' }}" id="braintree_private_key">

									@if ($errors->has('braintree[private_key]'))
									<span class="help-block">
										<strong>{{ $errors->first('braintree[private_key]') }}</strong>
									</span>
									@endif
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									value="{{ isset($currencyPaymentMethod->method_data) ? json_decode($currencyPaymentMethod->method_data)->merchant_id : '' }}" id="braintree_merchant_id">

									@if ($errors->has('braintree[merchant_id]'))
									<span class="help-block">
										<strong>{{ $errors->first('braintree[merchant_id]') }}</strong>
									</span>
									@endif
								</div>
							</div>
						...
						@elseif($list_menu == 'plaid')
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="processing_time">Processing Time (days)</label>
								<div class="col-sm-5">
									<input class="form-control" name="processing_time" type="text" placeholder="Stripe Processing Time" value="{{ isset($currencyPaymentMethod->processing_time) ? $currencyPaymentMethod->processing_time : '' }}" id="processing_time">
									@if ($errors->has('processing_time'))
    									<span class="help-block">
    										<strong>{{ $errors->first('processing_time') }}</strong>
    									</span>
				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1">
					    ...
					    <input type="hidden" id="getuser_id" value="{{\Auth::guard('admin')->user()->id}}">
