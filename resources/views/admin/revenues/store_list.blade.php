...
@section('page_content')
    ...
    <div class="box">
        <div class="box-body">
            <form class="form-horizontal" action="{{ url('admin/store/revenues') }}" method="GET">
                            ...
                            <tbody>
                                @foreach($revenues as $index=>$revenue)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{($revenue->charge_percentage == 0) && ($revenue->charge_fixed == 0) ? '-' : $revenue->charge_percentage + $revenue->charge_fixed}}</td>
