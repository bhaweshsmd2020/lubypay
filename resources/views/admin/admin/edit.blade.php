    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                ...
                <form action="{{ url('admin/update-admin', $admin->id) }}" class="form-horizontal" id="user_form"
                      method="POST">
                    ...
                    <div class="box-body">
                        ...
                        <!-- <div class="row">
							<div class="col-md-11">
								...
								<div class="col-md-2"><a class="btn btn-danger pull-left btn-flat" href="{{ url('admin/admins') }}" id="users_cancel">Cancel</a></div>
								<div class="col-md-1">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <a class="btn btn-danger pull-right btn-flat" href="{{ url('admin/admins') }}" id="users_cancel">Cancel</a>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <!-- <div class="box-footer">
                            <a class="btn btn-danger btn-flat pull-left" href="{{ url('admin/admins') }}"
