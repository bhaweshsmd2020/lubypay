    ...
    <div class="box box-default">
        <div class="box-body">
            <div class="row">
                ...
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'add_push_notifications'))
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                @foreach($promotions as $index=>$value)
                                    <tr>
                                        <td>{{++$index}}</td>
                                        <td>
                                            <?php
                                        ...
                                        <td>
                                            @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_push_notifications'))
                                                <a href="{{url('admin/promotions/edit/' . $value->id)}}" class="label label-primary"><i class="fa fa-edit"></i></a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
