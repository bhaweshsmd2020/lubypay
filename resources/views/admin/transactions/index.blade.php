                                ...
                                @foreach($transactions as $index=>$transaction)
                                    ...
                                    @if($transaction->transaction_type_id != '2' || ($transaction->transaction_type_id == '2' && $transaction->pay_type != '2'))
                                        <tr>
                                            ...
                                            <td><a href="{{ url('admin/users/edit/' . $transaction->user_id) }}">{{ !empty($sender) ? $sender : '-'}}</a></td>
                                            ...
                                            <td><a href="{{ url('admin/users/edit/' . $transaction->end_user_id)}}">{{ !empty($receiver) ? $receiver : '-'}}</a></td>
                                            <td>
                                            ...
                                            <td>
                                                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_transaction'))
