        ...
        <div class="col-md-9">
            ...
            <div class="box box-default">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-5">
                            <div class="top-bar-title padding-bottom pull-left">Add App Pages</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="box">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ url('admin/apppages/store') }}" method="post" class="form-horizontal" id="api-credentials" enctype="multipart/form-data" >
                                @csrf
        
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="inputEmail3">App Page</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" placeholder="App Page" name="app_page" type="text" id="app_page">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" placeholder="Page Name" name="page_name" type="text" id="page_name">
                                    </div>
                                </div>
