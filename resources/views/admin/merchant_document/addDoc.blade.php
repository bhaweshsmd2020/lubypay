...
@section('title', 'Add Merchant Group Document')
    ...
    <div class="col-md-9">
      ...
      <div class="box box-info">
        <div class="box-header with-border text-center">
          <h3 class="box-title">Add Document name for Merchant Package </h3>
        </div>

        <!-- form start -->
        <form method="POST" action="{{ url('admin/settings/add-merchant-group-document') }}" class="form-horizontal" enctype="multipart/form-data" id="merchant-group-add-form">
          {{ csrf_field() }}
