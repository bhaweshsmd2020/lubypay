...
@section('page_content')
    ...
    <div class="box">
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ url("admin/users/deposit/create/") }}" method="post" accept-charset='UTF-8' id="admin-user-deposit-create">
                        <input type="hidden" value="{{csrf_token()}}" name="_token" id="token">

                        <input type="hidden" name="user_id" id="user_id" value="">

                        <input type="hidden" name="fullname" id="user_name" value="">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-3">
                                    <div class="form-group">
                                       ...
                                       <select class="select2 wallet" name="user_id" id="user_id">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-5">
                                    <a href="{{ url('admin/users/edit/') }}" class="btn button-secondary"><span><i class="fa fa-angle-left"></i>&nbsp;Back</span></a>
