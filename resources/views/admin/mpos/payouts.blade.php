...
@section('page_content')
    ...
    <div class="box">
        <div class="box-body">
            <form class="form-horizontal" action="{{ url('admin/mpos/payouts') }}" method="GET">
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                @foreach($withdrawals as $index=>$deposit)
                                    <?php
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_mpos_payouts'))
                                                <a href="{{ url('admin/withdrawals/edit/' . $deposit->id) }}" class="label label-primary"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
