                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="package_fee" class="form-control"
                                       placeholder="Add package fee" id="package_fee" value="{{ number_format((float)$merchantGroup->package_fee, $preference['decimal_format_amount'], '.', '') }}"
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <label class="checkbox-container">
                                            <input type="checkbox" name="documents[]" value="{{$doc->id}}"
                                                   {{!empty($merchantGroup->documents) && in_array($doc->id,$merchantGroup->documents) ? 'checked' : ''}}
                                                   class="view_checkbox">
                                        </label>
                                    </div>
                                @endforeach
