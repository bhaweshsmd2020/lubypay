    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="box box-info">
                ...
                <!-- form start -->
                <form method="POST" action="{{ url('admin/settings/add-merchant-group') }}" class="form-horizontal"
                      enctype="multipart/form-data" id="merchant-group-add-form">
                    {{ csrf_field() }}
                    ...
                    <strong class="text-danger">{{ $errors->first('name') }}</strong>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea name="description" placeholder="Add description" rows="3" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="fee" class="form-control" value="{{ old('fee') }}"
                                       placeholder="Add fee" id="fee" oninput="restrictNumberToPrefdecimal(this)">
                                @if($errors->has('fee'))
                                    <span class="error">
                    <strong class="text-danger">{{ $errors->first('fee') }}</strong>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="exampleFormControlInput1">Package fee (%)</label>
                            <div class="col-sm-6">
                                <input type="text" name="package_fee" class="form-control"
                                       value="{{ old('package_fee') }}" placeholder="Add package fee" id="package_fee"
                                       oninput="restrictNumberToPrefdecimal(this)" required>
                                @if($errors->has('package_fee'))
                                    <span class="error">
                    <strong class="text-danger">{{ $errors->first('package_fee') }}</strong>
                  </span>
                                @endif
                                <div class="clearfix"></div>
                                <small class="form-text text-muted"><strong>{{ allowedDecimalPlaceMessage($preference['decimal_format_amount']) }}</strong></small>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="exampleFormControlInput1">Documents</label>
                        </div>
                        <div class="form-group">
                            @if($docs->count())
                                @foreach($docs as $doc)
                                    <div class="col-sm-6">
                                        <label class="col-sm-6 control-label" style="padding-top:unset;" for="exampleFormControlInput1">{{$doc->name}}</label>
