...
<div class="login-logo">
        @if(!empty($logo))
            <a href="{{ url('admin/') }}"><img src='{{ url('public/frontend/images/logomain.png') }}' class="img-responsive" width="282" height="63" style="width: 40%;
   
    margin: auto;"></a>
        @else
            <img src='{{ url('public/frontend/images/logomain.png') }}' class="img-responsive" width="282" height="63" style="width: 40%;
