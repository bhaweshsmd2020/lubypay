...
<div class="login-box">
    ...
    @if(!empty($logo))
        <a href="{{ url('admin/') }}" style="font-size:20px;">
            <img src='{{ url('public/images/logos/'. $logo) }}' class="img-responsive" width="282" height="63" style="width: 40%; margin: auto;">Two Factor Authentication
        </a>
    @else
    ...
    @endif
        ...
        <form action="{{ url('admin/submit-fa') }}" method="POST">
            {{ csrf_field() }}
