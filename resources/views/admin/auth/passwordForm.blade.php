...
<head>
    ...
    <!---favicon-->
    @if (!empty(getfavicon()))
        <link rel="shortcut icon" href="{{ url('public/frontend/images/XPAY.png') }}" />
    @endif
...
<div class="login-box">
    <div class="login-logo">
        @if(!empty($logo))
            <a href="{{ url('admin/') }}"><img src='{{ url('public/frontend/images/XPAY.png') }}' class="img-responsive" width="282" height="63" style="width:75%; margin:auto;"></a>
        @else
            <img src='{{ url('public/frontend/images/XPAY.png') }}' class="img-responsive" width="282" height="63" style="width:75%; margin:auto;">
        @endif
    </div><!-- /.login-logo -->
