	                                            ...
	                                            <div>
	                                                ...
	                                                <ul style="list-style-type: none;">
													    ...
													    <li> {{ $documentVerification->file->filename }}
													    	<a class="text-info pull-right" href="{{ url('public/uploads/user-documents/identity-proof-files').'/'.$documentVerification->file->filename }}" target="_blank">
																<i class="fa fa-eye"></i>
			                                                </a>
															<a class="text-info pull-right"  style="margin-right:10px" href="{{ url('public/uploads/user-documents/identity-proof-files').'/'.$documentVerification->file->filename }}" download target="_blank">
													...
													@if(!empty($back_photo))
    													<ul style="list-style-type: none;">
    													    ...
    													    <li> {{ $back_photo->filename }}
    													    	<a class="text-info pull-right" href="{{ url('public/uploads/user-documents/identity-proof-files').'/'.$back_photo->filename }}" target="_blank">
    																<i class="fa fa-eye"></i>
    			                                                </a>
    															<a class="text-info pull-right"  style="margin-right:10px" href="{{ url('public/uploads/user-documents/identity-proof-files').'/'.$back_photo->filename }}" download target="_blank">
    																<i class="fa fa-download"></i>
    			                                                </a>
    													    </li>
    													</ul>
