...
@section('page_content')
    ...
    <div class="box box-default">
        <div class="box-body">
            <div class="row">
                <div class="col-md-8">
                    <div class="top-bar-title padding-bottom pull-left">Address Verification</div>
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class=" dt-center">
                                            @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_identity_verfication'))
                                                <a href="{{ url('admin/address-proofs/edit/' . $document->id) }}" class="label label-primary"><i class="glyphicon glyphicon-edit"></i></a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
