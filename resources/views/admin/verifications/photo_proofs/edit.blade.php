...
@section('title', 'Edit Photo Verification')
				...
				<div class="col-md-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="row">
								<form action="{{ url('admin/photo-proofs/update') }}" class="form-horizontal" id="deposit_form" method="POST">
										{{ csrf_field() }}
										...
										<div class="panel panel-default">
											<div class="panel-body">
	                                            ...
	                                            <div>
	                                            	...
	                                            	<input type="hidden" class="form-control" name="photo_file" value="{{ $documentVerification->file->filename }}">
	                                                <ul style="list-style-type: none;">
	                                                	<h4 style="text-decoration: underline;">Photo Proof</h4>
													    <li> {{ $documentVerification->file->filename }}
													        <a class="text-info pull-right" href="{{ url('public/uploads/user-documents/photo-proof-files').'/'.$documentVerification->file->filename }}"  target="_blank">
													  			<i class="fa fa-eye"></i>
			                                                </a>
															<a class="text-info pull-right " style="margin-right:10px" href="{{ url('public/uploads/user-documents/photo-proof-files').'/'.$documentVerification->file->filename }}" download target="_blank">
									...
									<div class="row">
										<div class="col-md-11">
											...
											<div class="col-md-2"><a id="cancel_anchor" class="btn btn-danger pull-left" href="{{ url('admin/photo-proofs') }}">Cancel</a></div>
											<div class="col-md-1">
