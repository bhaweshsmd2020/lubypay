              ...
              <form action="{{ url('admin/settings/edit_currency/'.$result->id) }}" method="POST" class="form-horizontal" enctype="multipart/form-data" id="edit_currency_form">
                  ...
                  <div class="box-body">
                      ...
                      <div class="form-group" id="exchange-rate-div">
                          ...
                          <div class="col-sm-6">
                            <input type="text" name="card_rate" class="form-control" value="{{ (float)$result->card_rate }}" placeholder="Rate" id="card_rate" oninput="restrictNumberToEightdecimals(this)">
                            <span class="text-danger">{{ $errors->first('card_rate') }}</span>
                            <div class="clearfix"></div>
                            <small class="form-text text-muted"><strong>*Allowed upto 8 decimal places.</strong></small>
                          </div>
                      </div>
                      ...
                      <div class="form-group" id="exchange-from-div">
                          ...
                          <select class="form-control exchange_from" name="card_exchange_from" id="card_exchange_from">
                              <option value='local' {{ isset($result->card_exchange_from) && $result->card_exchange_from == 'local' ? 'selected':"" }}>local</option>
                              <option value='api' {{ isset($result->card_exchange_from) && $result->card_exchange_from == 'api' ? 'selected':"" }}>api</option>
                          </select>
                          <span class="text-danger">{{ $errors->first('card_exchange_from') }}</span>
                          </div>
                      </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            ...
                            @for($i=1;$i<=$total_currency;$i++)    
                            <option value="{{$i}}" @if($result->position ==$i) selected @endif>{{$i}}</option>
                            @endfor
                            </select>
                          </div>
                        </div>
