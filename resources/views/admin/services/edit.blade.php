    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="box box-info">
                ...
                <form action="{{ url('admin/settings/services_edit/' . $details->id) }}" method="post" class="form-horizontal" id="api-credentials" enctype="multipart/form-data" >
                    {!! csrf_field() !!}
                    ...
                    <div class="box-body">
                         <div class="form-group">
                             <label class="col-sm-4 control-label" for="inputEmail3">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" placeholder="Name" name="name" type="text" id="name" value="{{$details->name??''}}">
                                         @if($errors->has('name'))
                                         ...
                                         <select class="form-control" name="page" id="page">
                                            @if(!empty($app_pages))
                                               @foreach($app_pages as $value)
                                                 <option value="{{$value->app_page}}"  @if($details->page==$value->app_page) Selected  @endif>{{$value->page_name}}</option>
                                               @endforeach
                                            @endif
                                         </select>    
                                         @if($errors->has('page'))
                             ...
                             <label class="col-sm-4 control-label" for="inputEmail3">
                                        ...
                                        <div class="col-sm-8">
                                         <select class="form-control" name="position" id="position">
                                            <option value="Top"  @if($details->position=="Top") Selected  @endif>Top</option>
                                            <option value="Bottom"  @if($details->position=="Bottom") Selected  @endif>Bottom</option>
                                         </select>    
                             ...
                             <label class="col-sm-4 control-label" for="inputEmail3">
                                        ...
                                        <div class="col-sm-8">
                                         <select class="form-control" name="status" id="status">
                                              ...
                                              <option value="ComingSoon" @if($details->status=="ComingSoon") Selected  @endif>Coming Soon</option>
                                              <option value="ServiceDown" @if($details->status=="ServiceDown") Selected  @endif>Service Down</option>
                                         </select>    
                       ...
                       <div class="form-group">
                             <label class="col-sm-4 control-label" for="inputEmail3">
                                        ...
                                        <div class="col-sm-8">
                                       <input class="form-control" placeholder="Sorting" name="sorting" type="number" id="name" min=1 value="{{$details->sorting}}">
