            ...
            <ul class="nav nav-tabs cus" role="tablist">
                ...
                @php
                    foreach($documents as $document){
                        if($document['verification_type'] == 'identity'){
                            $url = 'admin/identity-proofs/edit/'.$document['id'];
                            @endphp
                            <li>
                              <a href="{{url($url)}}">Identity Proof</a>
                            </li>
                            @php
                        }
                        elseif($document['verification_type'] == 'address'){
                            $url = 'admin/address-proofs/edit/'.$document['id'];
                            @endphp
                            <li>
                              <a href="{{url($url)}}">Address Proof</a>
                            </li>
                            @php
                        }
                        else{
                            $url = 'admin/photo-proofs/edit/'.$document['id'];
                            @endphp
                            <li>
                              <a href="{{url($url)}}">Photo Proof</a>
                            </li>
                            @php
                        }
                    }
                                ...
                                <div class="col-md-7">
                                    ...
                                    <!-- <div class=" form-group row">
        								<div class="col-md-11">
        									...
        									<div class="col-md-2"><a class="btn btn-danger btn-flat pull-left" href="{{ url('admin/users') }}" id="users_cancel">
                                                Cancel
                                            </a></div>
        									<div class="col-md-1">
