                ...
                <form action="{{ url('admin/settings/api_informations') }}" method="post" class="form-horizontal" id="api-credentials" >
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="text" name="firebase_key" class="form-control" value="{{ $recaptcha['firebase_key'] }}" placeholder="Firebase key">

                            @if($errors->has('firebase_key'))
                                <span class="help-block">
                                  <strong class="text-danger">{{ $errors->first('firebase_key') }}</strong>
                                </span>
                            @endif
                          </div>
                        </div>
