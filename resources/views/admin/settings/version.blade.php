...
<div class="row">
    ...
    <div class="col-md-9">
        <div class="box box-info">
            ...
            <form action="{{ url('admin/settings/appversions') }}" method="post" class="form-horizontal" enctype="multipart/form-data" id="general_settings_form">
                @csrf
				...
				<div class="box-body">
					<div class="form-group">
					  ...
					  <div class="col-sm-6">
					    <input type="text" name="android_version" class="form-control" value="{{ @$result['android_version'] }}" placeholder="Android Version">
					  ...
					  <div class="col-sm-6">
					    <input type="text" name="android_url" class="form-control" value="{{ @$result['android_url'] }}" placeholder="Android URL">
					  	<span class="text-danger">{{ $errors->first('android_url') }}</span>
					</div>
					</div>
					<div class="form-group">
					  <label class="col-sm-4 control-label" for="inputEmail3">IOS Version</label>
					  <div class="col-sm-6">
					    <input type="text" name="ios_version" class="form-control" value="{{ @$result['ios_version'] }}" placeholder="IOS Version">
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-6">
					    <input type="text" name="ios_url" class="form-control" value="{{ @$result['ios_url'] }}" placeholder="IOS URL">
					  	<span class="text-danger">{{ $errors->first('ios_url') }}</span>
					  </div>
					</div>
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-6">
					    <input type="text" name="mpos_android_version" class="form-control" value="{{ @$result['mpos_android_version'] }}" placeholder="Mpos Android Version">
					  	<span class="text-danger">{{ $errors->first('mpos_android_version') }}</span>
					</div>
					</div>
						<div class="form-group">
					  <label class="col-sm-4 control-label" for="inputEmail3">Mpos Android URL</label>
					  <div class="col-sm-6">
					    <input type="text" name="mpos_android_url" class="form-control" value="{{ @$result['mpos_android_url'] }}" placeholder="Mpos Android URL">
					  	<span class="text-danger">{{ $errors->first('mpos_android_url') }}</span>
					</div>
					</div>
					<div class="form-group">
					  <label class="col-sm-4 control-label" for="inputEmail3">Mpos IOS Version</label>
					  <div class="col-sm-6">
					    <input type="text" name="mpos_ios_version" class="form-control" value="{{ @$result['mpos_ios_version'] }}" placeholder="Mpos IOS Version">
					  	<span class="text-danger">{{ $errors->first('mpos_ios_version') }}</span>
					  </div>
					</div>
					<div class="form-group">
					  <label class="col-sm-4 control-label" for="inputEmail3">Mpos IOS URL</label>
					  <div class="col-sm-6">
					    <input type="text" name="mpos_ios_url" class="form-control" value="{{ @$result['mpos_ios_url'] }}" placeholder="Mpos IOS URL">
					  	<span class="text-danger">{{ $errors->first('mpos_ios_url') }}</span>
					  </div>
					</div>
				</div>
