            ...
            <form action="{{ url('admin/settings') }}" method="post" class="form-horizontal" enctype="multipart/form-data" id="general_settings_form">
                ...
                <!-- box-body -->
                  ...
                  <!-- Default Language -->
        					...
        					<!--  <div class="col-sm-6">-->
        					<!--    <input type="text" name="virtual_card_fee" class="form-control" value="{{ @$result['virtual_card_fee'] }}" placeholder="Virtual Card Fee">-->
        					<!--  	<span class="text-danger">{{ $errors->first('virtual_card_fee') }}</span>-->
        					<!--  </div>-->
        					<!--</div>-->
