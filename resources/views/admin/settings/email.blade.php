        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header with-border text-center">
                    <h3 class="box-title">Email Settings @if(@$result['status']==1)(<span style="color: green"><i class="fa fa-check" aria-hidden="true"></i> Verified</span>) @endif </h3>
                </div>

                <form action="{{ url('admin/settings/email') }}" method="post" class="form-horizontal" id="emai_settings">
                {!! csrf_field() !!}
                ...
                <!-- box-body -->
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="notification_email" class="form-control" value="{{ @$result['notification_email'] }}" placeholder="Notification Email" id="notification_email">
                                @if($errors->has('notification_email'))
                                    <span class="help-block">
                                        <strong class="text-danger">{{ $errors->first('notification_email') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
