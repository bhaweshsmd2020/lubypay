                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-10 col-md-offset-1">
                                                        ...
                                                        <div class="col-md-8">
                                                            ...
                                                            value="{{ isset($credentials->europe_twilio_phone_number) ? $credentials->europe_twilio_phone_number : '' }}" placeholder="Enter Twilio Default Phone Number" id="">
                                                            @if ($errors->has('twilio.europe_twilio_phone_number'))
                                                                <span style="color:red;font-weight:bold;">{{ $errors->first('twilio.europe_twilio_phone_number') }}</span>
                                                            @endif
                                                            <div class="clearfix"></div>
                                                            <h6 class="form-text text-muted"><strong>*Must enter phone number without(+) symbol.</strong></h6>
                                                        </div>
