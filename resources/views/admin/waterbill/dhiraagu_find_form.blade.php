        ...
        <div class="col-md-12">
            <div class="box box-info">
                    <div class="box-header with-border text-center">
                      <h3 class="box-title">Find & Pay Dhiraagu Cable TV Bill</h3>
                    </div>
                    <div class="box-body">
            <div class="row">
                <div class="col-md-12 col-xs-12 mb20 ">
                    <div class="right mb10">
                     <span><a href="{{url('admin/utility/all-cable-bill')}}" style="background-color: #800000!important;float:right; border: none;font-weight: 400;"  class="btn btn-success"><i class="fa fa-arrow"></i>&nbsp; Back</a> </span>
                    </div>
                           ...
                           <div class="row">
                               <div class="col-md-6">
                                <div class="wap-wed mt20 mb20">
                                   <div class="row">
                                       <div class="col-md-6">
                                        <b>Load Cable TV Bill via phone number</b>
                                    </div>
                                  <div class="col-md-6">
