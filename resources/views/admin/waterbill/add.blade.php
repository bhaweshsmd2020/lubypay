  ...
  <div class="col-md-12" id="panel">
      ...
      <div class="box box-info">
        <div class="box-header with-border text-center">
          <h3 class="box-title">Find Cable TV Bill</h3>
        </div>
        ...
        <form method="POST" action="{{ url('admin/utility/pay-cable-bill') }}" class="form-horizontal" id="find_cable">
          ...
          <div class="box-footer">
            <a class="btn btn-danger" href="{{ url('admin/utility/all-cable-bill') }}">Cancel</a>
                              ...
                              $(document).ready(function(){
                                 ...
                                 $('#find_bill').on('click',function (){
                                   ...
                                   }else
                                   {
                                    ...
                                    $.ajax({
                                       type:"POST",
                                       url:"{{url('admin/utility/find-cable_tv-bill')}}",
                                       data : { 
                                            ...
                                            $("body").removeClass("loading");
                                             ...
                                             }else
                                             {
                                                  $("#panel").slideUp("slow");
                                                    ...
                                                    $.each(obj.product, function(index, product) {
                                                        var htmlString  =    '<tr>'
                                 ...
                                 $('#paycable').on('click',function (){
                                   ...
                                   {    
                                    $.ajax({
                                       type:"POST",
                                       url:"{{url('admin/utility/pay-cable_tv-bill')}}",
                                       data : { 
                                       ...
                                       success:function(res){               
                                        if(res){
                                            ...
                                            if(obj.msg == 'true')
                                            {
                                                swal({
                                                  title: "Congrulations!",
                                                  text: "Your Cable Tv Bill payment successfully Done!",
                                                  icon: "success",
                                                  button: "OK!",
                                                });
                                                 setTimeout(function(){
