...
@section('title', 'Edit Prepaid Card')
    ...
    <div class="col-md-9">
      ...
      <div class="box box-info">
        <div class="box-header with-border text-center">
          <h3 class="box-title">Edit Prepaid Card</h3>
        </div>

        <!-- form start -->
        <form method="POST" action="{{ url('admin/card/edit-prepaid-card') }}" class="form-horizontal" id="prepaid_card_form">
          {{ csrf_field() }}
          ...
          <div class="box-footer">
            <a class="btn btn-danger" href="{{ url('admin/card/prepaid-card') }}">Cancel</a>
            <button type="submit" class="btn btn-primary pull-right">&nbsp; Update Prepaid Card &nbsp;</button>
          </div>
        </form>
      </div>
    </div>
