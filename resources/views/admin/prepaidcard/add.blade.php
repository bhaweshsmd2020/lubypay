...
@section('title', 'Add Prepaid Card')
    ...
    <div class="col-md-9">
      ...
      <div class="box box-info">
        <div class="box-header with-border text-center">
          <h3 class="box-title">Add Prepaid Card</h3>
        </div>

        <!-- form start -->
        <form method="POST" action="{{ url('admin/card/add-prepaid-card') }}" class="form-horizontal" id="prepaid_card_form">
          {{ csrf_field() }}
          ...
          <div class="box-footer">
            ...
            <button type="submit" class="btn btn-primary pull-right">&nbsp; Add Prepaid Card &nbsp;</button>
          </div>
        </form>
      </div>
    </div>
