...
<ul class="sidebar-menu">
            ...
            <ul class="treeview-menu">
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_user'))
                    <li <?= isset($sub_menu) && $sub_menu == 'users_list' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/users') }}">
                            ...
                            @if(Common::user_unread_count('users', 'role_id', '2') > 0)
                                <span class="label label-warning">{{ Common::user_unread_count('users', 'role_id', '2') }}</span>
                            @endif
                        </a>
                    </li>
                
                    <li <?= isset($sub_menu) && $sub_menu == 'manualkyc' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/manual-kyc') }}">
                            <i class="fa fa-crosshairs"></i><span>KYC Status</span>
                            @if(Common::kyc_unread_count('users', 'role_id', '2') > 0)
                                <span class="label label-warning">{{ Common::kyc_unread_count('users', 'role_id', '2') }}</span>
                            @endif
                        </a>
                    </li>  
                @endif
                ...
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_transaction'))
                    <li <?= isset($sub_menu) && $sub_menu == 'all_transactions' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/transactions') }}">
                            ...
                            @if(Common::unread_tansactions('transactions') > 0)
                                <span class="label label-warning">{{ Common::unread_tansactions('transactions') }}</span>
                            @endif
                        </a>
                    </li>
                @endif
                ...
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_deposit'))
                    <li <?= isset($sub_menu) && $sub_menu == 'deposits' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/deposits') }}">
                            ...
                            @if(Common::unread_count('deposits') > 0)
                                <span class="label label-warning">{{ Common::unread_count('deposits') }}</span>
                            @endif
                        </a>
                    </li>
                @endif
                ...
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_withdrawal'))
                    <li <?= isset($sub_menu) && $sub_menu == 'withdrawals' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/withdrawals') }}">
                            ...
                            @if(Common::user_unread_count('withdrawals', 'pay_type', '1') > 0)
                                <span class="label label-warning">{{ Common::user_unread_count('withdrawals', 'pay_type', '1') }}</span>
                            @endif
                        </a>
                    </li>
                @endif
                ...
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_transfer'))
                    <li <?= isset($sub_menu) && $sub_menu == 'transfers' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/transfers') }}">
                            ...
                            @if(Common::unread_count('transfers') > 0)
                                <span class="label label-warning">{{ Common::unread_count('transfers') }}</span>
                            @endif
                        </a>
                    </li>
                @endif
                ...
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_request_payment'))
                    <li <?= isset($sub_menu) && $sub_menu == 'request_payments' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/request_payments') }}">
                            <i class="fa fa-calculator"></i><span >Request Payments</span>
                            @if(Common::unread_count('request_payments') > 0)
                                <span class="label label-warning">{{ Common::unread_count('request_payments') }}</span>
                            @endif
                        </a>
                    </li>
                @endif
                ...
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_exchange'))
                    <li <?= isset($sub_menu) && $sub_menu == 'exchanges' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/exchanges') }}">
                            ...
                            @if(Common::unread_count('currency_exchanges') > 0)
                                <span class="label label-warning">{{ Common::unread_count('currency_exchanges') }}</span>
                            @endif
                        </a>
                    </li>
                @endif
                
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_mobile_topup'))
                    <li <?= isset($sub_menu) && $sub_menu == 'prepaid' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/topup-list') }}">
                            <i class="fa fa-mobile"></i><span >Mobile Reload</span>
                            @if(Common::topup_unread_count('transactions') > 0)
                                <span class="label label-warning">{{ Common::topup_unread_count('transactions') }}</span>
                            @endif
                        </a>
                    </li>
                @endif
                
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_card'))
                    <li <?= isset($sub_menu) && $sub_menu == 'gift-card' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/card/gift-card') }}">
                            <i class="fa fa-credit-card-alt"></i><span >Gift Cards</span>
                            @if(Common::unread_count('gift_cards') > 0)
                                <span class="label label-warning">{{ Common::unread_count('gift_cards') }}</span>
                            @endif
                        </a>
                    </li>
                @endif
                ...
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_revenue'))
                    <li <?= isset($sub_menu) && $sub_menu == 'wallet_revenues' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/revenues') }}">
                            <i class="fa fa-book"></i><span >Revenues</span>
                            @if(Common::unread_revenues('transactions') > 0)
                                <span class="label label-warning">{{ Common::unread_revenues('transactions') }}</span>
                            @endif
                        </a>
                    </li>
                @endif
                
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_report'))
                    <li <?= isset($sub_menu) && $sub_menu == 'wallet_reports' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/report') }}">
                            <i class="fa fa-line-chart"></i><span >Reports</span>
                            @if(Common::unread_report('transactions') > 0)
                                <span class="label label-warning">{{ Common::unread_report('transactions') }}</span>
                            @endif
                        </a>
                    </li>
                @endif
    ...
    @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_merchant') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_stores') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_mpos_kyc') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_mpos_transactions') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_mpos_payouts') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_mpos_revenues') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_mpos_reports'))
        <li <?= $menu == 'mpos' ? ' class="active treeview"' : 'treeview'?> >
            <a href="#">
                ...
                @if(Common::user_unread_count('users', 'type', 'merchant') > 0 || Common::unread_count('stores') > 0 || Common::kyc_unread_count('users', 'type', 'merchant') > 0 || Common::unread_mpos_tansactions('transactions') > 0 || Common::user_unread_count('withdrawals', 'pay_type', '2') > 0 || Common::unread_mpos_revenues('transactions') > 0 || Common::unread_mpos_report('transactions') > 0)
                    <i class="fa fa-circle"></i>
                @endif
                <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
            </a>
            <ul class="treeview-menu">
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_merchant'))
                    <li <?= isset($sub_menu) && $sub_menu == 'merchant_list' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/merchant-list') }}">
                            ...
                            @if(Common::user_unread_count('users', 'role_id', '3') > 0)
                                <span class="label label-warning">{{ Common::user_unread_count('users', 'role_id', '3') }}</span>
                            @endif
                        </a>
                    </li>
                @endif
                ...
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_stores'))
                    <li <?= isset($sub_menu) && $sub_menu == 'store_list' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/store-list') }}">
                            ...
                            @if(Common::unread_count('stores') > 0)
                                <span class="label label-warning">{{ Common::unread_count('stores') }}</span>
                            @endif
                        </a>
                    </li>
                @endif
                ...
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_mpos_kyc'))
                    <li <?= isset($sub_menu) && $sub_menu == 'manualkyc' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/mpos-manual-kyc') }}">
                            <i class="fa fa-crosshairs"></i><span>KYC Status</span>
                            @if(Common::kyc_unread_count('users', 'role_id', '3') > 0)
                                <span class="label label-warning">{{ Common::kyc_unread_count('users', 'role_id', '3') }}</span>
                            @endif
                        </a>
                    </li> 
                @endif
                
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_mpos_transactions'))
                    <li <?= isset($sub_menu) && $sub_menu == 'store_transactions' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/mpos') }}">
                            <i class='fa fa-history'></i><span>Transactions</span>
                            @if(Common::unread_mpos_tansactions('transactions') > 0)
                                <span class="label label-warning">{{ Common::unread_mpos_tansactions('transactions') }}</span>
                            @endif
                        </a>
                    </li>
                @endif
                
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_mpos_payouts'))
                    <li <?= isset($sub_menu) && $sub_menu == 'store_payouts' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/mpos/payouts') }}">
                            <i class='fa fa-money'></i><span>Payouts</span>
                            @if(Common::user_unread_count('withdrawals', 'pay_type', '2') > 0)
                                <span class="label label-warning">{{ Common::user_unread_count('withdrawals', 'pay_type', '2') }}</span>
                            @endif
                        </a>
                    </li>
                @endif
                
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_mpos_revenues'))
                    <li <?= isset($sub_menu) && $sub_menu == 'store_revenues' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/store/revenues') }}">
                            <i class="fa fa-line-chart"></i><span>Revenues</span>
                            @if(Common::unread_mpos_revenues('transactions') > 0)
                                <span class="label label-warning">{{ Common::unread_mpos_revenues('transactions') }}</span>
                            @endif
                        </a>
                    </li>
                @endif
                    
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_mpos_reports'))
                    <li <?= isset($sub_menu) && $sub_menu == 'store_reports' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/store/report') }}">
                            <i class="fa fa-book"></i><span>Reports</span>
                            @if(Common::unread_mpos_report('transactions') > 0)
                                <span class="label label-warning">{{ Common::unread_mpos_report('transactions') }}</span>
                            @endif
                        </a>
                    </li>
                @endif
    ...
    @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_card_partner') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_card_holders') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_card_reloads') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_card_transfers') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_card_subscriptions'))
        <li <?= $menu == 'cards' ? ' class="active treeview"' : 'treeview'?> >
            ...
            <ul class="treeview-menu">
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_card_partner'))
                ...
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_card_holders'))
                    <li <?= isset($sub_menu) && $sub_menu == 'requests' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/card/requests') }}">
                            <i class="fa fa-user-o"></i><span>Cardholders</span>
                        </a>
                    </li>
                @endif
                
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_card_reloads'))
                    <li <?= isset($sub_menu) && $sub_menu == 'reloads' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/card/reloads') }}">
                            <i class="fa fa-plus-square"></i><span>Reloads</span>
                        </a>
                    </li>
                @endif
                
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_card_transfers'))
                    <li <?= isset($sub_menu) && $sub_menu == 'transfers' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/card/transfers') }}">
                            <i class="fa fa-upload"></i><span>Transactions</span>
                        </a>
                    </li>
                @endif
                
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_card_subscriptions'))
                    <li <?= isset($sub_menu) && $sub_menu == 'subscriptions' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/card/subscriptions') }}">
    ...
    @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_tickets') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_disputes'))
        <li <?= $menu == 'support' ? ' class="active treeview"' : 'treeview'?> >
            <a href="#">
                <i class='fa fa-ticket'></i><span>Support</span>
                @if(Common::unread_count('tickets') > 0)
                    <i class="fa fa-circle"></i>
                @endif
                <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
            </a>
            <ul class="treeview-menu">
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_tickets'))
                    <li <?= isset($sub_menu) && $sub_menu == 'ticket' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/tickets/list') }}">
                            <i class="fa fa-spinner"></i><span >Help & Support</span>
                            @if(Common::unread_count('tickets') > 0)
                                <span class="label label-warning">{{ Common::unread_count('tickets') }}</span>
                            @endif
                        </a>
                    </li>
                @endif
    ...
    @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_banner') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_offer') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_push_notifications') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_currency') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_country') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_email_setting') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_email_template') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_sms_setting') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_sms_template') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_language') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_app_level') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_notifications'))
        <li <?= $menu == 'configurations' || $menu == 'email' || $menu == 'sms' || $menu == 'language' || $menu == 'notification' ? ' class="active treeview"' : 'treeview'?> >
            ...
            <ul class="treeview-menu">
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_banner'))
                ...
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_offer'))
                    <li <?= isset($sub_menu) && $sub_menu == 'pushsms' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/pushsms') }}">
                            <i class="fa fa-bell"></i><span >App Offers</span>
                        </a>
                    </li>
                @endif
                
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_push_notifications'))
                ...
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_paymentmethods'))
                    <li <?= isset($sub_menu) && $sub_menu == 'paymentmethods' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/paymentmethods') }}">
                            <i class="fa fa-money"></i><span>Payment Methods</span>
                        </a>
                    </li>
                @endif

                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_transactiontypes'))
                    <li <?= isset($sub_menu) && $sub_menu == 'transactiontypes' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/transactiontypes') }}">
                ...
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_currency'))
                    <li <?= isset($sub_menu) && $sub_menu == 'currency' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/settings/currency') }}">
                ...
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_email_setting') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_email_template'))
                ...
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_notifications'))
                        ...
                        <ul class="treeview-menu">
                            ...
                            @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_notifications'))
                                <li <?= isset($sub_menu) && $sub_menu == 'notification_template' ? ' class="active"' : ''?>>
                                    <a href="{{url('admin/notification/template/1')}}">
                                        <i class="fa fa-newspaper-o"></i><span>Templates</span>
                                    </a>
                                </li>
                            @endif
                ...
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_sms_setting') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_sms_template'))
                ...
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_language') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_app_level'))
                        ...
                        <ul class="treeview-menu">
                            @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_language'))
                                <li <?= isset($sub_menu) && $sub_menu == 'language_config' ? ' class="active"' : ''?>>
                                    <a href="{{ url('admin/settings/language') }}">
                                        <i class="fa fa-cog"></i><span>Config</span>
                                    </a>
                                </li>
                            @endif
                            
                            @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_app_level'))
    ...
    @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_general_setting') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_blockio_settings') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_social_links') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_merchant_group') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_group') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_role') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_database_backup') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_meta') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_page') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_enable_woocommerce') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_preference') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_utility_setting') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_revenue_sharing') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_api_credentials') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_appstore_credentials') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_services') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_nfc_credentials') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_keys'))
        <li <?= $menu == 'settings' ? ' class="active treeview"' : 'treeview'?> >
            ...
            <ul class="treeview-menu">
                ...
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_api_credentials') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_appstore_credentials') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_services') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_nfc_credentials') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_keys'))
    ...
    @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'fraud_settings_view') || Common::has_permission(\Auth::guard('admin')->user()->id, 'fraud_report_view') || Common::has_permission(\Auth::guard('admin')->user()->id, 'view_activity_log'))
        <li <?= $menu == 'fraud_detection' ? ' class="active treeview"' : 'treeview'?> >
            <a href="#">
                <i class='fa fa-lock'></i><span>AML</span>
                @if(Common::unread_count('rule_reports') > 0)
                    <i class="fa fa-circle"></i>
                @endif
                <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
            </a>
            <ul class="treeview-menu">
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'fraud_settings_view'))
                    <li <?= isset($sub_menu) && $sub_menu == 'settings' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/settings/fraud-detection/1/9') }}">
                            <i class="fa fa-cog"></i>
                            <span>Config</span>
                        </a>
                    </li>
                @endif
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'fraud_report_view'))
                    <li <?= isset($sub_menu) && $sub_menu == 'reports' ? ' class="active"' : ''?> >
                        <a href="{{ url('admin/fraud-reports') }}">
                            <i class="fa fa-book"></i><span>Report</span>
                            @if(Common::unread_count('rule_reports') > 0)
                                <span class="label label-warning">{{ Common::unread_count('rule_reports') }}</span>
                            @endif
                        </a>
                    </li>
                @endif
    ...
    @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_unlink_device'))
        <li <?= $menu == 'unlinkdevice' ? ' class="active"' : 'treeview'?>>
            <a href="{{ url('admin/unlink-device') }}">
                <i class="fa fa-phone"></i><span>Unlink Device</span>
                @if(Common::lnkdev_unread_count('users') > 0)
                    <span class="label label-warning">{{ Common::lnkdev_unread_count('users') }}</span>
                @endif
            </a>
        </li>
    @endif
    
    @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_maintainance'))
        <li <?= $menu == 'maintainance' ? ' class="active"' : 'treeview'?>>
            <a href="{{ url('admin/maintainance-settings') }}">
                <i class="fa fa-cogs"></i><span>Maintenance</span>
            </a>
        </li>
    @endif
    
    @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_survey'))
    ...
    @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_subscriptions'))
    ...
    @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_ambassador_codes'))
        <li <?= $menu == 'ambassadorcodes' ? ' class="active"' : 'treeview'?>>
            <a href="{{ url('admin/ambassador-codes') }}">
