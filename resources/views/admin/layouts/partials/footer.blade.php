...
<div class="row" id="footerId">
      <div  class="col-sm-2">
       ...
       <a href="{{ route('dashboard') }}" class="logo" style="background-color: #0A4E92!important; border-radius: 0px 0px 0px 25px;height: 74px;">
    ...
    <div class="col-sm-6 text-center">
        <strong>Copyright &copy; {{date("Y")}} &nbsp;<a href="{{ route('dashboard') }}" target="_blank" style="color:#fff">{{ $company_name }}</a>&nbsp; |&nbsp; <!-- @lang('message.footer.copyright-text')-->
...
<div class="modal fade" id="confirmDelete" role="dialog" aria-labelledby="confirmDeleteLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" style="width:100%;height:100%; background-color: aliceblue;color: black">
