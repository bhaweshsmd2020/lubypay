                    ...
                    <div class="panel panel-info">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="btn-group pull-right">
                                        <a href="" class="btn btn-sm btn-default btn-flat" id="csv"><i class="fa fa-file-excel-o" style="font-size:16px"></i>&nbsp;CSV</a>&nbsp;&nbsp;
                                        <a href="" class="btn btn-sm btn-default btn-flat" id="pdf"><i class="fa fa-file-pdf-o" style="font-size:16px"></i>&nbsp;PDF</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                {!! $dataTable->table(['class' => 'table table-striped table-hover dt-responsive table-responsive', 'width' => '100%', 'cellspacing' => '0']) !!}
                            </div>
                        </div>
                    </div>
                </div>
