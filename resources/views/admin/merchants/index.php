                        ...
                        <div class='head'>
                            ...
                            <span class='icons'>
                                ...
                                <span class="vwp d-md-none mprf" no="<?php gec($usr['id']); ?>">
                                    <img class="lazyimg" data-src="<?php gec(url().gr_img('users', $usr['id'])); ?>">
                                </span>
                            </span>
                        </div>
                        <div class="search">
                    ...
                    <div class="col-md-6 nomob panel" no=0>
                        <div class='head groupnav d-none'>
                            ...
                            <span class='left'>
                                ...
                                <span style="
    padding-left: 109px;
"><button onclick="window.location.href = 'https://video.smdtechno.com';" style="
    border-radius: 4px;
    border: 1px solid #e8e8e8;
    font-size: 14px;
    background: #32e832;
">Video Session</button></span>
                    ...
                    <div class="col-md-3 nomob aside rside">
                        ...
                        <div class="tabs">
                            <ul>
                                ...
                                <li act='crew' class='grtab d-none' zero='0' zval='<?php gec($GLOBALS["lang"]['zero_crew']) ?>' side='rside'><!--<?php gec($GLOBALS["lang"]['crew']) ?>-->Team</li>
    ...
    <div class="dumb d-none">
        ...
        <audio id='gralert'>
            <source src="<?php gec(url().gr_profile('get', $usr['id'], 'alert')); ?>" />
        </audio>
