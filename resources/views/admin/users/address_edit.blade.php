    ...
    <div class="box">
      <div class="box-body">
        <div class="row">
            <div class="col-md-12">
                <!-- form start -->
                <form action="{{ url('admin/users/address_update') }}" class="form-horizontal" id="user_form" method="POST">
                    {{ csrf_field() }}
                            ...
                            <div class="col-md-12">
                                <div class="col-md-7">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" placeholder="Update Address Line 1" name="address_1" type="text" id="address_1" value="{{ $users_details->address_1 }}">
                                        </div>
                                    </div>
                                      <div class="form-group">
                                        <label class="col-sm-4 control-label" for="inputEmail3">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" placeholder="Update Address Line 2" name="address_2" type="text" id="address_2" value="{{ $users_details->address_2 }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" for="inputEmail3">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" placeholder="Update city Name" name="city" type="text" id="city" value="{{ $users_details->city }}">
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        <label class="col-sm-4 control-label" for="inputEmail3">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" placeholder="Update State Name" name="state" type="text" id="state" value="{{ $users_details->state }}">
                                        </div>
                                    </div>
                                     <div class="form-group ">
                                                   <label class="col-sm-4 control-label" for="inputEmail3">
                                         ...
                                         <div class="col-sm-8">
                                                    <select class="form-control" name="country" id="country_id">
                                                        @foreach($countries as $country)
                                                            <option value="{{$country->id}}" <?= ($users_details->country== $country->id) ? 'selected' : '' ?> >{{$country->name}}</option>
                                                        @endforeach
                                                    </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" placeholder="Update Zip Code " name="zip_code" type="text" id="zip_code" value="{{ $users_details->zip_code }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <a class="btn btn-danger btn-flat" href="{{ url('admin/users') }}" id="users_cancel" style="display:flex">
                                                Cancel
                                            </a>
