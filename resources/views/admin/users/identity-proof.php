    ...
    <div class="box">
       <div class="panel-body">
            <ul class="nav nav-tabs cus" role="tablist">
                ...
                <li class="active">
                  <a href="{{url("admin/users/identity-proof/$users->id")}}">Identity Proof</a>
                </li>
                <li>
                  <a href="{{url("admin/users/address-proof/$users->id")}}">Address Proof</a>
                </li>
                <li>
                  <a href="{{url("admin/users/photo-proof/$users->id")}}">Photo Proof</a>
                </li>
                 <li>
