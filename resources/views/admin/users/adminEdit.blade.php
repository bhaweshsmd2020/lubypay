                    ...
                    <div class="box-body">
                        ...
                        <!-- <div class="row">
							<div class="col-md-11">
								...
								<div class="col-md-2"><a class="btn btn-danger pull-left btn-flat" href="{{ url('admin/admin_users') }}" id="users_cancel">Cancel</a></div>
								<div class="col-md-1">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <a class="btn btn-danger pull-right btn-flat" href="{{ url('admin/admin_users') }}" id="users_cancel">Cancel</a>
                            </div>
                            <div class="col-sm-6">
