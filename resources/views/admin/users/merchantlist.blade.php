...
@section('page_content')
    ...
    <div class="box box-default">
        <div class="box-body">
            <div class="row">
                <div class="col-md-10">
                    <div class="top-bar-title padding-bottom pull-left">Merchants</div>
                </div>
                <div class="col-md-2 pull-right">
                    @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'add_user'))
                        <a href="{{url('admin/users/create')}}" class="btn btn-success btn-flat"><span class="fa fa-plus"> &nbsp;</span>Add Merchant</a>
                    @endif
                </div>
            </div>
        </div>
