   ...
   <div class="panel-body">
       ...
       <!--</ul>-->
        ...
        <ul class="nav nav-tabs cus" role="tablist">
                ...
                <li>
                  <a href="{{url("admin/users/photoproof/$user_id")}}">Photo Proof</a>
                </li>
                
                <li >
                  <a href="{{url("admin/users/addressproof/$user_id")}}">Address Proof</a>
                </li>
                
                <li >
                  <a href="{{url("admin/users/idproof/$user_id")}}">Identity Proof</a>
                </li>
                <li>
                  <a href="{{url("admin/users/bankdetails/$user_id")}}">Bank Details</a>
                </li>
           </ul>
