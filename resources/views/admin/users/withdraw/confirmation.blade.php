                            ...
                            <div class="panel-body">
                                ...
                                <h3 class="text-center"><strong>Details</strong></h3>
                                 <p class="mb20">
                                     ...
                                     $dtls = DB::table('payout_settings')->where('user_id',$user_id)->where('type',$payment_method_id)->first();
                                     $pyt_dtls = DB::table('payment_methods')->where('id',$payment_method_id)->first();
                                    
                                     ?>
                                    @lang('message.dashboard.payout.new-payout.withdraw-via')&nbsp;&nbsp;<img src="{{asset("public/images/payment_gateway")}}/{{strtolower($pyt_dtls->name)}}.jpg"/>
                                </p>
                                 @if ( isset($pyt_dtls) && $pyt_dtls->name == 'Bank')
                                    <p class="mb20"> @lang('message.dashboard.payout.payout-setting.modal.bank-account-holder-name')&nbsp;&nbsp;: <b>{{ $dtls->account_name }}</b></p>
                                    <p class="mb20"> @lang('message.dashboard.payout.payout-setting.modal.account-number')&nbsp;&nbsp;: <b>{{ $dtls->account_number }}</b></p>
                                    <p class="mb20"> @lang('message.dashboard.payout.payout-setting.modal.swift-code')&nbsp;&nbsp;: <b>{{ $dtls->swift_code }}</b></p>
                                    <p class="mb20"> @lang('message.dashboard.payout.payout-setting.modal.bank-name')&nbsp;&nbsp;: <b>{{ $dtls->bank_name }}</b></p>
                                @endif
                            
                                <div class="row">
                                    <div class="col-md-6 pull-left"><b>Details</b></div>
                                </div>
                                <div class="row">
