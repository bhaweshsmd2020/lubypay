                            ...
                            <tbody>
                                @foreach($orders as $k=>$order)
                                    <tr>
                                        ...
                                        <td>{{ !empty($order->customer_name) ? $order->customer_name : '-'}}</td>
                                        ...
                                        <td>
                                            @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_orders'))
                                                <a href="{{ url('admin/store/orders/edit/'.$store_detail->id.'/'.$order->id) }}" class="label label-primary"><i class="glyphicon glyphicon-edit" data-toggle="tooltip" title="Edit"></i></a>&nbsp;
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
