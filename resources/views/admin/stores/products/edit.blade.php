...
@section('title', 'Edit Store Product')
    ...
    <div class="box">
      <div class="box-body">
        <div class="row">
            <div class="col-md-12">
                <!-- form start -->
                <form action="{{ url('admin/store/product/update') }}" class="form-horizontal" id="user_form" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}

                    <input type="hidden" value="{{ $store_detail->id }}" name="store_id" id="id">
                    <input type="hidden" value="{{ $product->id }}" name="prod_id" id="id">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" placeholder="Name" name="name" type="text" id="name" value="{{ $product->name }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" placeholder="Description" name="description" type="text" id="description" value="{{ $product->description }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" placeholder="Price" name="price" type="text" id="price" value="{{ $product->price }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" placeholder="Quantity" name="quantity" type="text" id="quantity" value="{{ $product->quantity }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" placeholder="SKU" name="product_sku" type="text" id="product_sku" value="{{ $product->user_product_id }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control" name="discount_type" id="discount_type">
                                                <option value="percent" @if($product->discount_type == 'percent') selected @endif>Percentage</option>
                                                <option value="fixed" @if($product->discount_type == 'fixed') selected @endif>Fixed</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" placeholder="Discount" name="discount" type="text" id="discount" value="{{ $product->discount }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            @if(!empty($product->image))
                                                <img src="{{ asset('public/user_dashboard/product/thumb/'. $product->image) }}" style="width: 300px; height: auto;">
                                            @endif
                                        </div>
                                    </div>
                                    
                                    @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_products'))
                                        <div class="form-group">
