                            ...
                            <tbody>
                                @foreach($tickets as $k=>$ticket)
                                    <tr>
                                        ...
                                        <td><a href="{{ url('admin/tickets/edit/' . $ticket->id) }}">{{$ticket->code}}</a></td>
                                        <td>
                                            @if(!empty($ticket->user->first_name))
                                                <a href="{{ url('admin/users/edit/' . $ticket->user->id) }}">{{$ticket->user->first_name .' '.$ticket->user->last_name}}</a>
                                            @else
                                                -
                                            @endif
                                        </td>
                                        <td><a href="{{ url('admin/tickets/edit/' . $ticket->id) }}">{{$ticket->subject}}</a></td>
                                        <td>
                                        ...
                                        <td class=" dt-center">
                                            ...
                                            <a href="{{ url('admin/tickets/reply/' . $ticket->id)}}" class="label label-success"><i class="fa fa-reply"></i></a>&nbsp;
                                            
                                            @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_ticket'))
                                                <a href="{{ url('admin/tickets/edit/' . $ticket->id) }}" class="label label-primary"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;
                                            @endif
                        
                                            @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'delete_ticket'))
                                                <a href="{{ url('admin/tickets/delete/' . $ticket->id) }}" class="label label-danger delete-warning"><i class="glyphicon glyphicon-trash"></i></a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
