...
@section('title', 'Ooredoo Postpaid')
...
.overlay{
  ...
  <div class="col-md-8" id="panel">
      ...
      <div class="box box-info">
        ...
        <form method="POST" action="{{ url('admin/utility/pay-cable-bill') }}" class="form-horizontal" id="find_cable">
          ...
          <div class="box-footer">
            <a class="btn btn-danger" href="{{ url('admin/all-dhiragu-bill') }}">Cancel</a>
    ...
    <div class="col-md-12" id="processed">
      ...
      <div class="box box-info">
        <div class="box-header with-border text-center">
          <h3 class="box-title">Pay Postpaid With Ooredoo</h3>
        </div>
        ...
        <form method="POST" action="{{ url('admin/utility/pay-cable-bill') }}" class="form-horizontal" id="pay_cable_form">
          ...
          <div class="box-footer">
            <a class="btn btn-danger" href="{{ url('admin/all-dhiragu-bill') }}">Back</a>
                              ...
                              $(document).ready(function(){
                                 ...
                                 $('#find_bill').on('click',function (){
                                   ...
                                   }else
                                   {
                                    ...
                                    $.ajax({
                                       type:"POST",
                                        url:"{{url('admin/load-ooredoo-customer-for-postpaid')}}",
                                       data : { 
                                       ...
                                       success:function(res){               
                                        if(res){
                                            ...
                                            $('#amount').val(obj.response["Previous Amount"]);
                                            var htmlString  =    '<tr>'
                                                        htmlString +=    '<td>'+ obj.response["Customer Code"] +'</td>'
                                                        htmlString +=    '<td>'+ obj.response["Plan Name"] +'</td>'
                                                        htmlString +=    '<td>'+ obj.response["Previous Amount"] +'</td>'
                                                        htmlString +=    '</tr>';
                                 ...
                                 $('#paycable').on('click',function (){
                                   ...
                                   {    
                                    $.ajax({
                                       type:"POST",
                                       url:"{{url('admin/pay-ooredoo-postpaid')}}",
                                       data : { 
                                        _token: "{{ csrf_token() }}",account_id:account_id,amount:amount,user_id:user_id
                                       },
                                       beforeSend: function() {
                                            $("body").addClass("loading"); 
                                        }, 
