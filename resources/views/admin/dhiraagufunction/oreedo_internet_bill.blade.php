...
@section('title', 'Pay Internet Bill')
  ...
  <div class="col-md-12" id="panel">
      ...
      <div class="box box-info">
        <div class="box-header with-border text-center">
          <h3 class="box-title">Find Internet Bill By Ooredoo Account ID</h3>
        </div>
        ...
        <form method="POST" action="{{ url('admin/utility/pay-cable-bill') }}" class="form-horizontal" id="find_cable">
          ...
          <div class="box-footer">
            <a class="btn btn-danger" href="{{ url('admin/dhiragu-internet-bill') }}">Cancel</a>
    ...
    <div class="col-md-12" id="processed">
      ...
      <div class="box box-info">
        <div class="box-header with-border text-center">
          <h3 class="box-title">Pay Internet Bill By Ooredoo</h3>
        </div>
        ...
        <form method="POST" action="{{ url('admin/utility/pay-cable-bill') }}" class="form-horizontal" id="pay_cable_form">
          ...
          <div class="box-footer">
            <a class="btn btn-danger" href="{{ url('admin/dhiragu-internet-bill') }}">Back</a>
      ...
      <div class="col-md-6">
         <div class="box box-info">
        <div class="box-header with-border text-center">
          <h3 class="box-title">Internet Bill Details</h3>
        </div> 
                              ...
                              $(document).ready(function(){
                                 ...
                                 $('#find_bill').on('click',function (){
                                   ...
                                   }else
                                   {
                                    ...
                                    $.ajax({
                                       type:"POST",
                                        url:"{{url('admin/load-ooredoo-internet-bill')}}",
                                       data : { 
                                       ...
                                       success:function(res){               
                                        if(res){
                                            $("body").removeClass("loading");
                                             ...
                                             console.log(obj.response["Payment Balance"]);
                                             if(obj.status == 'false')
                                             {
                                                  swal({
                                                  title: obj.title,
                                            ...
                                            $('#amount').val(obj.response["Payment Balance"]);
                                            var htmlString  =    '<tr>'
                                                        htmlString +=    '<td>'+ obj.response["User ID"] +'</td>'
                                                        htmlString +=    '<td>'+ obj.response["Payment Balance"] +'</td>'
                                                        htmlString +=    '</tr>';
                                 ...
                                 $('#paycable').on('click',function (){
                                    ...
                                    //alert(user_id);
                                    if((account_id == '')||(amount == '')||(user_id == '')||(amount ==0.00)||(slected_product_id == ''))
                                   {
                                       swal({
                                              title: "Validation Error!",
                                              text: "All fields are required!",
                                   ...
                                   {    
                                    $.ajax({
                                       type:"POST",
                                       url:"{{url('admin/pay-ooredoo-internet-bill')}}",
                                       data : { 
                                        _token: "{{ csrf_token() }}",number:number,account_id:account_id,amount:amount,user_id:user_id,product_id:slected_product_id
                                       },
                                       beforeSend: function() {
                                            $("body").addClass("loading"); 
                                        }, 
