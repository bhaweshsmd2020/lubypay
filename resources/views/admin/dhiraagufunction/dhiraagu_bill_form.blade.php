...
@section('title','Dhiraagu Internet Bill')
        ...
        <div class="col-md-12">
            <div class="box box-info">
                    <div class="box-header with-border text-center">
                      <h3 class="box-title">Find & Pay Dhiraagu Internet Bill</h3>
                    </div>
                    <div class="box-body">
            <div class="row">
                <div class="col-md-12 col-xs-12 mb20 ">
                    <div class="right mb10">
                     <span><a href="{{url('admin/dhiragu-internet-bill')}}" style="background-color: #800000!important;float:right; border: none;font-weight: 400;"  class="btn btn-success"><i class="fa fa-arrow"></i>&nbsp; Back</a> </span>
                    </div>
                           ...
                           <div class="row">
                               <div class="col-md-6">
                                <div class="wap-wed mt20 mb20">
                                   <div class="row">
                                       <div class="col-md-6">
                                        <b>Load Internet Bill via phone number</b>
                                    </div>
                                  <div class="col-md-6">
                         ...
                         <script>
                          $(document).ready(function(){
                             ...
                             $('#pay_postpaid').on('click',function (){
                                ...
                                var finder             = 'Dhiraagu_Internet';
                                var number = $('#phone').val();
                                if((PaymentIdentifier != '')&&(pay_amount != '')&&(bill_number != '')&&(add_remark != '')&&(description != ''))
                                {
                                   $.ajax({
                                   type:"POST",
                                   url:"{{url('admin/dhiraagu-pay-internet')}}",
                                   data : { 
                                        _token: "{{ csrf_token() }}" ,finder:finder,number:number,PaymentIdentifier:PaymentIdentifier,pay_amount:pay_amount,bill_number:bill_number,add_remark:add_remark,description:description
                                    },
                                   beforeSend: function() {
                                        $("body").addClass("loading"); 
                                    }, 
