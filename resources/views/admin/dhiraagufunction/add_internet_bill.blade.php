  ...
  <div class="col-md-12" id="panel">
      ...
      <div class="box box-info">
        <div class="box-header with-border text-center">
          <h3 class="box-title">Find Internet Bill By Dhiraagu Account ID</h3>
        </div>
    ...
    <div class="col-md-12" id="processed">
      ...
      <div class="box box-info">
        <div class="box-header with-border text-center">
          <h3 class="box-title">Pay Internet Bill</h3>
        </div>
                              ...
                              $(document).ready(function(){
                                 ...
                                 $('#find_bill').on('click',function (){
                                   ...
                                   }else
                                   {
                                    ...
                                    $.ajax({
                                       type:"POST",
                                        url:"{{url('admin/load-internet-bill')}}",
                                       data : { 
                                       ...
                                       success:function(res){               
                                        if(res){
                                            ...
                                            $("#processed").show();
                                                ...
                                                $.each(obj.response.product, function(index, product) {
                                                    var htmlString  =    '<tr>'
                                                        htmlString +=    '<td>'+ product.product_name +'</td>'
                                                        htmlString +=    '<td>'+ product.product_price +'</td>'
                                                        htmlString +=    '<td>'+ product.product_allowance +'</td>'
                                 ...
                                 $('#paycable').on('click',function (){
                                   ...
                                   {    
                                    $.ajax({
                                       type:"POST",
                                       url:"{{url('admin/pay-internet-bill')}}",
                                       data : { 
