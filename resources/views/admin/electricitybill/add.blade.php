...
.overlay{
  ...
  <div class="col-md-12" id="panel">
      ...
      <div class="box box-info">
        ...
        <form method="POST" action="{{ url('admin/utility/pay-cable-bill') }}" class="form-horizontal" id="find_cable">
          ...
          <div class="box-footer">
            <a class="btn btn-danger" href="{{ url('admin/utility/electricity') }}">Cancel</a>
    ...
    <div class="col-md-12" id="processed">
      ...
      <div class="box box-info">
        <div class="box-header with-border text-center">
          <h3 class="box-title">Pay Electricity Bill</h3>
        </div>
  ...
  <ul class="list-group">
    ...
    <li class="list-group-item"  >Due Date <span id="Name" class="badge">5</span></li>
                              ...
                              $(document).ready(function(){
                                 ...
                                 $('#find_bill').on('click',function (){
                                   ...
                                   }else
                                   {
                                    ...
                                    $.ajax({
                                       type:"POST",
                                       url:"{{url('admin/utility/find-electricity-bill')}}",
                                       data : { 
                                 ...
                                 $('#paycable').on('click',function (){
                                    ...
                                    var user_id   = $('#user_id').val();
                                        //alert(user_id);
                                    if((account_id == '')||(amount == '')||(user_id == '')||(user_id == null))
                                   {
                                       swal({
                                              title: "Validation Error!",
                                              text: "All fields are required!",
                                   ...
                                   {    
                                    $.ajax({
                                       type:"POST",
                                       url:"{{url('admin/utility/pay-electricity-bill')}}",
                                       data : { 
                                       ...
                                       success:function(res1){               
                                        if(res1){
                                            ...
                                            if(obj.msg == 'true')
                                            {
                                                swal({
                                                  title: "Congrulations!",
                                                  text: "Your Electricity Bill payment successfully Done!",
                                                  icon: "success",
                                                  button: "OK!",
                                                });
                                                 setTimeout(function(){
                                            ...
                                            }else
                                            {
                                                swal({
                                                  title: "Sorry!",
                                                  text: "Could not found any bill of this amount!",
                                                  icon: "error",
                                                  button: "Error!",
                                                });
                                                 setTimeout(function(){
