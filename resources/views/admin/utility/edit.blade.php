    ...
    <div class="col-md-9">
      ...
      <div class="box box-info">
        <div class="box-header with-border text-center">
          <h3 class="box-title">Utility Bill</h3>
        </div>

        <!-- form start -->
        <form method="POST" action="{{ url('admin/utility/edit') }}" class="form-horizontal" id="utility_form">
          {{ csrf_field() }}
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <select name="country_id" class="form-control select2" placeholder="Select Country" id="country_id">
                    ...
                    <option @if($countries->id==$result->country_id) selected @endif value="{{$countries->id}}">{{$countries->name}}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" name="type" class="form-control" value="{{ $result->type }}" placeholder="Select Type" id="type">
                @if($errors->has('type'))
                <span class="help-block">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" name="provider_name" class="form-control" value="{{ $result->provider_name }}" placeholder="Enter your Provider Name" id="provider_name">
