                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                @foreach($transfers as $index=>$deposit)
                                    <?php
                                    ...
                                    <tr>
                                        ...
                                        <td>{{formatNumber($deposit->fee)}}</td>
                                        <td>{{formatNumber($deposit->fee + $deposit->amount)}}</td>
                                        ...
                                        <td>
                                            @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_transfer'))
                                                <a href="{{ url('admin/transfers/edit/' . $deposit->id) }}" class="label label-primary"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
