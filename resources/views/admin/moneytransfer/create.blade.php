...
@section('page_content')
   ...
   <div class="box">
    ...
    <div class="row">
        <div class="col-md-2">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button style="margin-top: 15px;"  type="button" class="btn button-secondary btn-flat active">Send Money</button>
        </div>
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form method="POST" action="{{url('admin/users/moneytransfer/'.$user_id)}}" id="transfer_form" accept-charset='UTF-8'>
                        ...
                        <div class="card" style="    border: 0px;">
                            <div class="card-header" style="    background: #ecf0f5;
    border: none;">
                            ...
                            <div class="card-header">
                                <div class="chart-list float-left">
                                <h3>@lang('message.dashboard.send-request.send.title')</h3>
                                </div></div>
                                <hr>
                                ...
                                <div class="form-group">
                                   ...
                                   <select class="form-control receiver select2" name="receiver" id="receiver" style="width: 60%;" onchange="this.value = this.value.replace(/\s/g, '')">
                                        <option value="">Select Recipient</option>
                                       <?php foreach($users as $use){?>
                                       <option value="{{$use->email}}">{{$use->carib_id}} - {{$use->first_name}} {{$use->last_name}}</option>
                                       <?php } ?>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary btn-cust1 col-12 transfer_form" id="send_money">
