...
@section('page_content')
	 <div class="col-md-7" id="panel">
      <!-- Horizontal Form -->
      <div class="box box-info">
			<div class="row">
				<div class="col-md-8 col-xs-12 mb20" style="padding: 10px 33px;width: 100%;">
					<div class="card">
						...
						<div class="card-footer">
							<div class="text-center">
								<a href="{{url('admin/users/moneytransfer/'.$transInfo['user_id'])}}" class="send-money-confirm-back-link">
								 	<button class="btn btn-danger float-left send-money-confirm-back-button"><strong><i class="fa fa-angle-left"></i>&nbsp;&nbsp;@lang('message.dashboard.button.back')</strong></button>
								</a>
								<a href="{{url('admin/users/send-money-confirm/'.$transInfo['user_id'])}}" class="sendMoneyPaymentConfirmLink">
								    <input type="hidden" name="user_id" value="{{$transInfo['user_id']}}">
									<button class="btn btn-primary float-right sendMoneyConfirm">
