              ...
              <div class="col-md-8 col-xs-12 mb20" style="padding: 10px 33px;width: 100%;">
                  <div class="card">
                      ...
                      <div class="card-footer" style="margin-top: 10px">
                          <div class="text-center">
                            <a href="{{url('admin/users/moneytransfer/print')}}/{{$transInfo['trans_id']}}" target="_blank" class="btn btn-cust"><strong>@lang('message.dashboard.vouchers.success.print')</strong></a>
                            <a href="{{url('admin/users/moneytransfer/'.$user_id)}}" class="btn btn-cust"><strong>@lang('message.dashboard.send-request.send.confirmation.send-again')</strong></a>
                          </div>
                      </div>
                  </div>
              </div>
