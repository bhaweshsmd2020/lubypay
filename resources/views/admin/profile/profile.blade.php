...
@section('page_content')
    <div class="box">
       <div class="panel-body">
            <div class="row">
                <div class="col-md-8">
                    <h3>{{ ucwords(Auth::guard('admin')->user()->first_name.' '.Auth::guard('admin')->user()->last_name) }}</h3>
                </div>
                <div class="col-md-4 text-right">
                    @if (Auth::guard('admin')->user()->status == 'Inactive')
                        <h3>Status: <span class="label label-danger">Inactive</span></h3>
                    @elseif (Auth::guard('admin')->user()->status == 'Suspended')
                        <h3>Status: <span class="label label-warning">Suspended</span></h3>
                    @elseif (Auth::guard('admin')->user()->status == 'Active')
    ...
    <div class="box">
       <div class="panel-body">
            <ul class="nav nav-tabs cus" role="tablist">
                ...
                <li>
                  <a href="{{ url("admin/change-password")}}">Security</a>
                </li>
           </ul>
    ...
    <div class="box">
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
                    <form action='{{ url("admin/update-profile", $admin_id) }}' method="POST" class="form-horizontal" enctype="multipart/form-data" id="profile_form">
                        {!! csrf_field() !!}
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" value="{{Auth::guard('admin')->user()->first_name}}" class="form-control" id="first_name" name="first_name">
                                ...
                                <div class="col-md-5">
                                    <center>
                                        @if (!empty(Auth::guard('admin')->user()->picture))
                                            <img src='{{url("public/uploads/userPic/$admin_picture")}}' style="border-radius:100%; width:250px; height:250px; margin-bottom: 30px;">
                                        @else
                                            <img src='{{url("public/admin_dashboard/img/avatar.jpg")}}' style="border-radius: 50%; width: auto; height: 300px; margin-bottom: 30px;">
                                        @endif
                                    </center>
                                </div>
                            </div>
