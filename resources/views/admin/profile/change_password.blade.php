                                ...
                                <div class="col-md-5">
                                    <center>
                                        @if (!empty(Auth::guard('admin')->user()->picture))
                                            <img src='{{url("public/uploads/userPic/". Auth::guard('admin')->user()->picture)}}' style="border-radius:100%; width:250px; height:250px; margin-bottom: 30px;">
                                        @else
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a data-toggle="modal" data-target="#modal-form2fa" href="" class="btn btn-neutral">
                        ...
                        @elseif(Auth::guard('admin')->user()->fa_status==1)
