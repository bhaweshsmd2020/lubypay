...
<?php
    $check_transaction = DB::table('transactions')->where('transaction_reference_id', $transaction->id)->where('transaction_type_id', '41')->first();
				...
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<div class="row">
								<div class="col-md-9">
									<h4 class="text-left">Subscription Details</h4>
								</div>
								<div class="col-md-3">
								...
								<form class="form-horizontal">
										...
										<div class="panel panel-default">
											<div class="panel-body">
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
													  <p class="form-control-static">XXXX XXXX XXXX {{$transaction->last_four}}</p>
													</div>
												</div>
									...
									<div class="row">
										<div class="col-md-11">
											...
											<div class="col-md-2"><a id="cancel_anchor" class="btn btn-danger pull-left" href="{{ url('admin/card/subscriptions') }}">Cancel</a></div>
										</div>
									</div>
								</form>
							</div>
