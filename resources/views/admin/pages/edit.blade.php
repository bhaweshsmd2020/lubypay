    ...
    <div class="col-md-9">
      ...
      <div class="box-body">
        ...
        <form action="{{url('admin/settings/page/update')}}" method="post" id="page" class="form-horizontal" enctype="multipart/form-data">
            ...
            <input class="form-control" name="language_id" value="{{ $language->id }}" type="hidden">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        @foreach($all_languages as $all_lang)
                          <li class="<?php if($all_lang->id == $language->id) { echo 'active'; } ?>">
                            <a data-spinner="true" href='{{url("admin/settings/page/edit/$page->id/$all_lang->id")}}'>{{ $all_lang->language }}</a>
                          </li>
                        @endforeach
                    </ul>
                </div>
                <div class="col-md-9">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input class="form-control" name="name" value="{{ $page_name }}" type="text">
                          @if ($errors->has('name'))
                              <span class="error">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea id="content" class="form-control" name="content" placeholder="Content" rows="10" cols="80" >{{ $page_content }}</textarea>
