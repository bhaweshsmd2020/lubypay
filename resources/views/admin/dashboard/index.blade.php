                ...
                <div class="box box-info">
                    ...
                    <div class="box box-body">
                        @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_user'))
                            <div class="col-md-3">
                                <a href="{{url('admin/users')}}" style="color: #fff;">
                        ...
                        @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_transaction'))
                            <div class="col-md-3">
                                <a href="{{url('admin/transactions')}}" style="color: #fff;">
                        ...
                        @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_deposit'))
                            <div class="col-md-3">
                                <a href="{{url('admin/deposits')}}" style="color: #fff;">
                                    <div class="small-box bg-green" >
                                        ...
                                        <a href="{{url('admin/deposits')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                                    </div>
                                </a>
                            </div>
                        @endif
                        ...
                        @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_withdrawal'))
                            <div class="col-md-3">
                                <a href="{{url('admin/withdrawals')}}" style="color: #fff;">
                                    <div class="small-box bg-red">
                                        ...
                                        <a href="{{url('admin/withdrawals')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                                    </div>
                                </a>
                            </div>
                        @endif
                        ...
                        @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_tickets'))
                            <div class="col-md-3">
                                <a href="{{url('admin/tickets/list')}}" style="color: #fff;">
                        ...
                        @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_disputes'))
                            <div class="col-md-3">
                                <a href="{{url('admin/disputes')}}" style="color: #fff;">
                ...
                <div class="box box-info">
                    ...
                    <div class="box box-body">
                        @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_merchant'))
                            <div class="col-md-3">
                                <a href="{{url('admin/merchant-list')}}" style="color: #fff;">
                                    <div class="small-box bg-red">
                                        <div class="inner" style="padding: 10px;">
                                            <div class="icon">
                                        ...
                                        <a href="{{url('admin/merchant-list')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                                    </div>
                                </a>
                            </div>
                        @endif
                        ...
                        @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_stores'))
                            <div class="col-md-3">
                                <a href="{{url('admin/store-list')}}" style="color: #fff;">
                                    <div class="small-box bg-green">
                                        <div class="inner" style="padding: 10px;">
                                            <div class="icon">
                                                <i class="fa fa-ticket"></i>
                                        ...
                                        <a href="{{url('admin/store-list')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                                    </div>
                                </a>
                            </div>
                        @endif
                        ...
                        @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'view_mpos_transactions'))
                            <div class="col-md-3">
                                <a href="{{url('admin/mpos')}}" style="color: #fff;">
                                    <div class="small-box bg-green" style="background-color: #795548 !important;">
                                        <div class="inner" style="padding: 10px;">
                                            <div class="icon">
                                                <i class="fa fa-money"></i>
                                            ...
                                            <p class="cardTitle">Today’s Transactions</p>
                                            <h3>{{$mpos_todaytransactions}}</h3>
                                        </div>
                                        <div class="icon">
                                            <i class="ion ion-stats-bars"></i>
                                        </div>
                                        <a href="{{url('admin/mpos')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                                    </div>
                                </a>
                            </div>
                        @endif
