...
return [
    ...
    'home'                 => [
        ...
        'banner'          => [
            'title'      => 'Payments Connected.:br Commerce Transformed. ',
            'des'        => 'A single source for all your payments needs.',
            'sub-title1' => 'Simple to :br Integrate',
            'sub-title2' => 'Multi :br Currencies',
            'sub-title3' => 'Simple :br Checkout',
        ],
        'choose-us'       => [
            'title'      => 'Why choose us?',
    ...
    'dashboard'            => [
        ...
        'button'        => [
            ...
            'create'          => 'Create',
            'activate'        => 'Activate',
            'new-merchant'    => 'New Merchant Business',
            'new-shipment-cost'=> 'Add Shipping Cost',
            'details'         => 'Details',
        ...
        'deposit'       => [
            ...
            'deposit-stripe-form'                         => [
                'title'   => 'Deposit with Debit/Credit Card',
                'card-no' => 'Card Number',
                'mm-yy'   => 'MM/YY',
                'cvc'     => 'CVC',
            ],
        ...
        'payout'        => [
            'menu'           => [
                // 'list' => 'List',
                'payouts'        => 'Withdraw',
                'payout-setting' => 'Withdraw Setting',
                'new-payout'     => 'New Withdraw',
                'details'        => 'Withdrawal Detail',
            ],
            'details' => [
                ...
                'date'                  => 'Date',
                'status'                => 'Status',
                'payout-method'         => 'Withdrawal Method',
                'transaction-detail'    => 'Transactions Withdrawn',
            ],
            'list'           => [
                'method'      => 'Method',
            ...
            'new-payout'     => [
                ...
                //new
                'success'           => 'Success',
                'payout-success'    => 'Withdraw Completed Successfully',
                'payout-again'      => 'Withdraw Again',
                'withdraw-source'   => 'Withdraw From',
                'sales-list'        => 'Sales to Withdraw',
                'withdraw-from-shop'   => 'Online E-commerce',
                'withdraw-from-other'   => 'CaribPay Wallet',
            ],
        ],
        'confirmation'  => [
            'details' => 'Details',
        ...
        'transaction'   => [
            ...
            'total-sales'     => 'Total Shop Sales',
            'total-due'       => 'Total Withdrawable',
        ],
        'exchange'      => [
            'left-top'    => [
        ...
        'merchant'      => [
            'menu'                => [
                ...
                'list'          => 'List',
                'details'       => 'Details',
                'edit-merchant' => 'Edit Merchant Business',
                'new-merchant'  => 'New Merchant Business',
            ],
            'table'               => [
                'id'            => 'ID',
            ...
            'add'                 => [
                ...
                'note'     => 'Note',
                'price'    => 'Shipment Cost',
                'duration' => 'Delivery Duration (In Days)',
 ...
 'carriers'             => "Select Shipping Carrier",
